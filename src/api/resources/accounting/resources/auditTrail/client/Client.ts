...
export class AuditTrailClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.accounting.AuditLogEvent, Merge.accounting.PaginatedAuditLogEventList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Merge.accounting.AuditTrailListRequest,
            ): Promise<core.WithRawResponse<Merge.accounting.PaginatedAuditLogEventList>> => {
        ...
        return new core.Page<Merge.accounting.AuditLogEvent, Merge.accounting.PaginatedAuditLogEventList>({

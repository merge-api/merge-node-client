...
export class AccountsClient {
     ...
     * Creates an `Account` object with the given values.
     *
     * @param {Merge.accounting.AccountsAsyncBulkCreateRequest} request
     * @param {AccountsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const _queryParams: Record<string, unknown> = {
                    ...
                    classification:
                        classification != null
                            ? serializers.accounting.AccountsBatchObjectsListRequestClassification.jsonOrThrow(
                                  classification,
                                  { unrecognizedObjectKeys: "strip" },
                              )
                            : undefined,
                    ...
                    remote_fields:
                        remoteFields != null
                            ? serializers.accounting.AccountsBatchObjectsListRequestRemoteFields.jsonOrThrow(
                                  remoteFields,
                                  { unrecognizedObjectKeys: "strip" },
                              )
                            : undefined,

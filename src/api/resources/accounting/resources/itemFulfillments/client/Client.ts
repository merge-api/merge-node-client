...
export class ItemFulfillmentsClient {
     ...
     * Creates an `ItemFulfillment` object with the given values.
     *
     * @param {Merge.accounting.ItemFulfillmentsAsyncBulkCreateRequest} request
     * @param {ItemFulfillmentsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const _queryParams: Record<string, unknown> = {
                    ...
                    expand: Array.isArray(expand)
                        ? expand.map((item) =>
                              serializers.accounting.ItemFulfillmentsBatchObjectsListRequestExpandItem.jsonOrThrow(
                                  item,
                                  { unrecognizedObjectKeys: "strip" },
                              ),
                          )

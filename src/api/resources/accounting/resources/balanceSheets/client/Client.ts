...
export class BalanceSheetsClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<BalanceSheetsClient.Options>;
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.accounting.BalanceSheet, Merge.accounting.PaginatedBalanceSheetList>> {
        ...
        return new core.Page<Merge.accounting.BalanceSheet, Merge.accounting.PaginatedBalanceSheetList>({

...
export class IssuesClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.accounting.Issue, Merge.accounting.PaginatedIssueList>> {
        ...
        return new core.Page<Merge.accounting.Issue, Merge.accounting.PaginatedIssueList>({

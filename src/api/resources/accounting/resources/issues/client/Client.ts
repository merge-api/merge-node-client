...
export class Issues {
     ...
     *
     * @param {Merge.accounting.ListIssuesRequest} request
    ...
    private async __list(
        ...
        if (status != null) {
            _queryParams["status"] = serializers.accounting.ListIssuesRequestStatus.jsonOrThrow(status, {
     ...
     *
     * @param {string} id
     * @param {Merge.accounting.RetrieveIssuesRequest} request
     * @param {Issues.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example

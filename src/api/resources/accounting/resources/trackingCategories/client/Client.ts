...
export class TrackingCategoriesClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.accounting.TrackingCategory, Merge.accounting.PaginatedTrackingCategoryList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const _queryParams: Record<string, unknown> = {
                    category_type:
                        categoryType != null
                            ? serializers.accounting.TrackingCategoriesListRequestCategoryType.jsonOrThrow(
                                  categoryType,
        ...
        return new core.Page<Merge.accounting.TrackingCategory, Merge.accounting.PaginatedTrackingCategoryList>({

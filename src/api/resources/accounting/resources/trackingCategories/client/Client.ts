...
export class TrackingCategories {
    ...
    public async list(
        ...
        if (_response.ok) {
            return await serializers.accounting.PaginatedTrackingCategoryList.parseOrThrow(_response.body, {
    ...
    public async retrieve(
        ...
        if (_response.ok) {
            return await serializers.accounting.TrackingCategory.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],

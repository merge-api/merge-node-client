...
export class TrackingCategoriesClient {
    protected readonly _options: TrackingCategoriesClient.Options;
    ...
    private async __list(
        ...
        if (categoryType != null) {
            _queryParams.category_type = serializers.accounting.TrackingCategoriesListRequestCategoryType.jsonOrThrow(
                categoryType,
        ...
        if (status != null) {
            _queryParams.status = serializers.accounting.TrackingCategoriesListRequestStatus.jsonOrThrow(status, {
                unrecognizedObjectKeys: "strip",
            });
        }

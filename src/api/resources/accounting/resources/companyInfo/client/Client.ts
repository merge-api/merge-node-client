...
export class CompanyInfoClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.accounting.CompanyInfo, Merge.accounting.PaginatedCompanyInfoList>> {
        ...
        return new core.Page<Merge.accounting.CompanyInfo, Merge.accounting.PaginatedCompanyInfoList>({

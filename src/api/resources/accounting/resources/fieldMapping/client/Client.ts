...
export class FieldMapping {
    ...
    public async fieldMappingsRetrieve(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                "api/accounting/v1/field-mappings"
            ),
            method: "GET",
            headers: {
     ...
     *
     * @example
     *     await merge.accounting.fieldMapping.fieldMappingsDestroy("string")
     */
    public async fieldMappingsDestroy(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MergeEnvironment.Production,
                `api/accounting/v1/field-mappings/${fieldMappingId}`
            ),
            method: "DELETE",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
     ...
     *
     * @example
     *     await merge.accounting.fieldMapping.fieldMappingsPartialUpdate("string", {
     *         remoteMethod: "GET",
     *         remoteUrlPath: "/example-url-path"
     *     })
     */
    ...
    public async remoteFieldsRetrieve(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MergeEnvironment.Production,
                "api/accounting/v1/remote-fields"
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
    ...
    public async targetFieldsRetrieve(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MergeEnvironment.Production,
                "api/accounting/v1/target-fields"
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),

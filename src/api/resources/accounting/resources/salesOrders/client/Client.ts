...
export class SalesOrdersClient {
    ...
    private async __asyncBulkCreate(
        ...
        if (_response.ok) {
            return {
                data: serializers.accounting.AsyncBulkCreateResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __batchObjectsList(
        ...
        if (_response.ok) {
            return {
                data: serializers.accounting.BatchObjectsResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,

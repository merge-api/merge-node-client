...
export class SalesOrdersClient {
    ...
    private async __list(
        ...
        const _queryParams: Record<string, unknown> = {
            ...
            expand:
                expand != null
                    ? serializers.accounting.SalesOrdersListRequestExpand.jsonOrThrow(expand, {
    ...
    private async __retrieve(
        ...
        const _queryParams: Record<string, unknown> = {
            expand:
                expand != null
                    ? serializers.accounting.SalesOrdersRetrieveRequestExpand.jsonOrThrow(expand, {
                          unrecognizedObjectKeys: "strip",
                      })
                    : undefined,
            include_remote_data: includeRemoteData,
    ...
    private async __batchObjectsList(
        ...
        const _queryParams: Record<string, unknown> = {
            ...
            expand:
                expand != null
                    ? serializers.accounting.SalesOrdersBatchObjectsListRequestExpand.jsonOrThrow(expand, {
                          unrecognizedObjectKeys: "strip",
                      })
                    : undefined,
            include_deleted_data: includeDeletedData,

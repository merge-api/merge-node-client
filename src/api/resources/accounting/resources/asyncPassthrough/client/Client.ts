...
export class AsyncPassthrough {
     ...
     * @param {Merge.accounting.RetrieveAsyncPassthroughRequest} request
     * @param {AsyncPassthrough.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public retrieve(
        ...
        requestOptions?: AsyncPassthrough.RequestOptions,
    ): core.HttpResponsePromise<Merge.accounting.RemoteResponse> {
    ...
    private async __retrieve(
        ...
        request: Merge.accounting.RetrieveAsyncPassthroughRequest = {},
        requestOptions?: AsyncPassthrough.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.accounting.RemoteResponse>> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return {
                data: serializers.accounting.RemoteResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,

...
export class VendorCreditsClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.accounting.VendorCredit, Merge.accounting.PaginatedVendorCreditList>> {
        ...
        return new core.Page<Merge.accounting.VendorCredit, Merge.accounting.PaginatedVendorCreditList>({
     ...
     * Creates a `VendorCredit` object with the given values.
     *
     * @param {Merge.accounting.VendorCreditBulkRequest} request
     * @param {VendorCreditsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    private async __asyncBulkCreate(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
            requestType: "json",
            body: serializers.accounting.VendorCreditBulkRequest.jsonOrThrow(_body, {
                unrecognizedObjectKeys: "strip",
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,

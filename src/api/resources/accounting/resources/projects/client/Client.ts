...
export class ProjectsClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.accounting.Project, Merge.accounting.PaginatedProjectList>> {
        ...
        return new core.Page<Merge.accounting.Project, Merge.accounting.PaginatedProjectList>({

...
export class Scopes {
    ...
    ): core.HttpResponsePromise<Merge.accounting.CommonModelScopeApi> {
    ...
    private async __defaultScopesRetrieve(
        requestOptions?: Scopes.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.accounting.CommonModelScopeApi>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.accounting.CommonModelScopeApi.parseOrThrow(_response.body, {

...
export class TaxRatesClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.accounting.TaxRate, Merge.accounting.PaginatedTaxRateList>> {
        ...
        return new core.Page<Merge.accounting.TaxRate, Merge.accounting.PaginatedTaxRateList>({
    ...
    private async __retrieve(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/accounting/v1/tax-rates/{id}");
    }
}

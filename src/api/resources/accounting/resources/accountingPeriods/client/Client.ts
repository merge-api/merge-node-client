...
export class AccountingPeriods {
    ...
    /**
     * Returns a list of `AccountingPeriod` objects.{/* BEGIN_ACCOUNTING_PERIOD_FETCH_SUPPORTED_FIELDS * /}{/* END_ACCOUNTING_PERIOD_FETCH_SUPPORTED_FIELDS * /}
     *
     * @param {Merge.accounting.ListAccountingPeriodsRequest} request
    ...
    /**
     * Returns an `AccountingPeriod` object with the given `id`.{/* BEGIN_ACCOUNTING_PERIOD_FETCH_SUPPORTED_FIELDS * /}{/* END_ACCOUNTING_PERIOD_FETCH_SUPPORTED_FIELDS * /}
     *
     * @param {string} id
     * @param {Merge.accounting.RetrieveAccountingPeriodsRequest} request
     * @param {AccountingPeriods.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example

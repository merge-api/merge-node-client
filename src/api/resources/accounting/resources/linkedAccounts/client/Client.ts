...
export class LinkedAccountsClient {
    ...
    public async list(
        ...
        core.Page<Merge.accounting.AccountDetailsAndActions, Merge.accounting.PaginatedAccountDetailsAndActionsList>
    > {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const _queryParams: Record<string, unknown> = {
                    category:
                        category != null
                            ? serializers.accounting.LinkedAccountsListRequestCategory.jsonOrThrow(category, {
                ...
                if (_response.ok) {
                    return {
                        data: serializers.accounting.PaginatedAccountDetailsAndActionsList.parseOrThrow(
                            _response.body,
                            {

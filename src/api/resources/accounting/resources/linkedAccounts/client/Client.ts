...
export class LinkedAccounts {
     ...
     *
     * @param {Merge.accounting.ListLinkedAccountsRequest} request
    ...
    private async __list(
        ...
        if (category !== undefined) {
            _queryParams["category"] = serializers.accounting.ListLinkedAccountsRequestCategory.jsonOrThrow(category, {

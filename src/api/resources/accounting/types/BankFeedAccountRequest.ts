 ...
 */
export interface BankFeedAccountRequest {
     ...
     * * `INACTIVE` - INACTIVE
     */
    feedStatus?: Merge.accounting.FeedStatusEnum | null;
     ...
     */
    accountType?: Merge.accounting.BankFeedAccountAccountTypeEnum | null;

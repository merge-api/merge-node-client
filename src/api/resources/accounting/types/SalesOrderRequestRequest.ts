 ...
 */
export interface SalesOrderRequestRequest {
    /** The customer associated with the sales order. */
    customer?: Merge.accounting.SalesOrderRequestRequestCustomer;
    /**
     ...
     * * `CLOSED` - CLOSED
     */
    status?: Merge.accounting.SalesOrderRequestRequestStatus;
    /** The payment terms applied to this order. */
    paymentTerm?: Merge.accounting.SalesOrderRequestRequestPaymentTerm;
    /** Notes or comments attached to the order. */
    memo?: string;
    /** The shipping address for the order. */
    shippingAddress?: Merge.accounting.SalesOrderRequestRequestShippingAddress;
    trackingCategories?: (Merge.accounting.SalesOrderRequestRequestTrackingCategoriesItem | undefined)[];
    ...
    total?: number;
    lines?: Merge.accounting.SalesOrderRequestRequestLinesItem[];

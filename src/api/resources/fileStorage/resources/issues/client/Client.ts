...
export class IssuesClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.fileStorage.Issue, Merge.fileStorage.PaginatedIssueList>> {
        ...
        return new core.Page<Merge.fileStorage.Issue, Merge.fileStorage.PaginatedIssueList>({

...
export class AsyncPassthrough {
     ...
     * @param {Merge.filestorage.RetrieveAsyncPassthroughRequest} request
     * @param {AsyncPassthrough.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public retrieve(
        ...
        requestOptions?: AsyncPassthrough.RequestOptions,
    ): core.HttpResponsePromise<Merge.filestorage.RemoteResponse> {
    ...
    private async __retrieve(
        ...
        request: Merge.filestorage.RetrieveAsyncPassthroughRequest = {},
        requestOptions?: AsyncPassthrough.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.filestorage.RemoteResponse>> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return {
                data: serializers.filestorage.RemoteResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,

...
export class AccountDetails {
    ...
    ): core.HttpResponsePromise<Merge.filestorage.AccountDetails> {
        return core.HttpResponsePromise.fromPromise(this.__retrieve(requestOptions));
    }

    private async __retrieve(
        requestOptions?: AccountDetails.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.filestorage.AccountDetails>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.filestorage.AccountDetails.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError(
                    "Timeout exceeded when calling GET /filestorage/v1/account-details.",
                );
            case "unknown":
                throw new errors.MergeError({

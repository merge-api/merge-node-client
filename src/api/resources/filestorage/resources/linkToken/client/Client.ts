...
export class LinkTokenClient {
     ...
     *
     * @param {Merge.filestorage.EndUserDetailsRequest} request
    ...
    ): core.HttpResponsePromise<Merge.filestorage.LinkToken> {
    ...
    private async __create(
        request: Merge.filestorage.EndUserDetailsRequest,
        requestOptions?: LinkTokenClient.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.filestorage.LinkToken>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.filestorage.LinkToken.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling POST /filestorage/v1/link-token.");
            case "unknown":
                throw new errors.MergeError({

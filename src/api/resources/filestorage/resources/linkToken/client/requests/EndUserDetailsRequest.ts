...
export interface EndUserDetailsRequest {
    ...
    shouldCreateMagicLinkUrl?: boolean | null;
    ...
    hideAdminMagicLink?: boolean | null;
    /** An array of objects to specify the models and fields that will be disabled for a given Linked Account. Each object uses model_id, enabled_actions, and disabled_fields to specify the model, method, and fields that are scoped for a given Linked Account. */
    commonModels?: Merge.filestorage.CommonModelScopesBodyRequest[] | null;
    /** When creating a Link Token, you can set permissions for Common Models that will apply to the account that is going to be linked. Any model or field not specified in link token payload will default to existing settings. */
    categoryCommonModelScopes?: Record<
        string,
        Merge.filestorage.IndividualCommonModelScopeDeserializerRequest[] | null
    > | null;
    /**
     ...
     * * `de` - de
     */
    language?: Merge.filestorage.LanguageEnum | null;
    /** The boolean that indicates whether initial, periodic, and force syncs will be disabled. */
    areSyncsDisabled?: boolean | null;
    /** A JSON object containing integration-specific configuration options. */
    integrationSpecificConfig?: Record<string, unknown> | null;
    /**
     ...
     */
    completedAccountInitialScreen?: Merge.filestorage.CompletedAccountInitialScreenEnum | null;

...
export class Scopes {
     ...
     *
     * @example
     *     await merge.filestorage.scopes.defaultScopesRetrieve()
     */
    public async defaultScopesRetrieve(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                "api/filestorage/v1/default-scopes"
            ),
            method: "GET",
            headers: {
        ...
        if (_response.ok) {
            return await serializers.filestorage.CommonModelScopeApi.parseOrThrow(_response.body, {
     ...
     *
     * @example
     *     await merge.filestorage.scopes.linkedAccountScopesRetrieve()
     */
    public async linkedAccountScopesRetrieve(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MergeEnvironment.Production,
                "api/filestorage/v1/linked-account-scopes"
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
     ...
     *
     * @example
     *     await merge.filestorage.scopes.linkedAccountScopesCreate({
     *         commonModels: []
     *     })
     */
    public async linkedAccountScopesCreate(
        ...
        const _response = await core.fetcher({
            ...
            contentType: "application/json",
            body: await serializers.filestorage.LinkedAccountCommonModelScopeDeserializerRequest.jsonOrThrow(request, {

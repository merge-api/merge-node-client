...
export class Scopes {
    ...
    public async defaultScopesRetrieve(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /filestorage/v1/default-scopes.");
            case "unknown":
                throw new errors.MergeError({
     ...
     *
     * @param {Merge.filestorage.LinkedAccountCommonModelScopeDeserializerRequest} request
     * @param {Scopes.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example

...
export class ForceResyncClient {
    ...
    ): core.HttpResponsePromise<Merge.filestorage.SyncStatus[]> {
    ...
    private async __syncStatusResyncCreate(
        requestOptions?: ForceResyncClient.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.filestorage.SyncStatus[]>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.filestorage.forceResync.syncStatusResyncCreate.Response.parseOrThrow(_response.body, {

...
export class ForceResync {
     ...
     *
     * @example
     *     await merge.filestorage.forceResync.syncStatusResyncCreate()
     */
    public async syncStatusResyncCreate(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                "api/filestorage/v1/sync-status/resync"
            ),
            method: "POST",
            headers: {
        ...
        if (_response.ok) {
            return await serializers.filestorage.forceResync.syncStatusResyncCreate.Response.parseOrThrow(
                _response.body,
                {

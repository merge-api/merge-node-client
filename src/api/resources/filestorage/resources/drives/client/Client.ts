...
export declare namespace DrivesClient {
...
export class DrivesClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<DrivesClient.Options>;

    constructor(options: DrivesClient.Options) {
     ...
     * @param {DrivesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.filestorage.Drive, Merge.filestorage.PaginatedDriveList>> {
        ...
        return new core.Page<Merge.filestorage.Drive, Merge.filestorage.PaginatedDriveList>({
    ...
    private async __retrieve(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MergeEnvironment.Production,
                `filestorage/v1/drives/${core.url.encodePathParam(id)}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/filestorage/v1/drives/{id}");
    }
}

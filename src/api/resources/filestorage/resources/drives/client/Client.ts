...
export class Drives {
     ...
     *
     * @example
     *     await merge.filestorage.drives.list({})
     */
    public async list(
        ...
        if (_response.ok) {
            return await serializers.filestorage.PaginatedDriveList.parseOrThrow(_response.body, {
    ...
    public async retrieve(
        ...
        if (_response.ok) {
            return await serializers.filestorage.Drive.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,

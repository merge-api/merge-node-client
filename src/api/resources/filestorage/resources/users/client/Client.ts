...
export class UsersClient {
     ...
     *
     * @param {Merge.filestorage.UsersListRequest} request
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.filestorage.User, Merge.filestorage.PaginatedUserList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/filestorage/v1/users");
            },
        );
        const dataWithRawResponse = await list(request).withRawResponse();
        return new core.Page<Merge.filestorage.User, Merge.filestorage.PaginatedUserList>({
     ...
     *
     * @param {string} id
     * @param {Merge.filestorage.UsersRetrieveRequest} request
     * @param {UsersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    private async __retrieve(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MergeEnvironment.Production,
                `filestorage/v1/users/${core.url.encodePathParam(id)}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/filestorage/v1/users/{id}");
    }
}

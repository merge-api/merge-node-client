...
export class LinkedAccounts {
     ...
     *
     * @param {Merge.filestorage.ListLinkedAccountsRequest} request
    ...
    private async __list(
        ...
        if (category !== undefined) {
            _queryParams["category"] = serializers.filestorage.ListLinkedAccountsRequestCategory.jsonOrThrow(category, {

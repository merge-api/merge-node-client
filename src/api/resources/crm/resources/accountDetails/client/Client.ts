...
export class AccountDetails {
    ...
    ): core.HttpResponsePromise<Merge.crm.AccountDetails> {
        return core.HttpResponsePromise.fromPromise(this.__retrieve(requestOptions));
    }

    private async __retrieve(
        requestOptions?: AccountDetails.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.crm.AccountDetails>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.crm.AccountDetails.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /crm/v1/account-details.");
            case "unknown":
                throw new errors.MergeError({

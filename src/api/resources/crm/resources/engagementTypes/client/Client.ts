...
export class EngagementTypesClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.crm.EngagementType, Merge.crm.PaginatedEngagementTypeList>> {
        ...
        return new core.Page<Merge.crm.EngagementType, Merge.crm.PaginatedEngagementTypeList>({

...
export class ForceResync {
     ...
     */
    public async syncStatusResyncCreate(requestOptions?: ForceResync.RequestOptions): Promise<Merge.crm.SyncStatus[]> {
        ...
        if (_response.ok) {
            return serializers.crm.forceResync.syncStatusResyncCreate.Response.parseOrThrow(_response.body, {

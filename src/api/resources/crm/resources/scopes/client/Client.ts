...
export class ScopesClient {
    ...
    private async __defaultScopesRetrieve(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/crm/v1/default-scopes");
    }
    ...
    private async __linkedAccountScopesRetrieve(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/crm/v1/linked-account-scopes");
    }

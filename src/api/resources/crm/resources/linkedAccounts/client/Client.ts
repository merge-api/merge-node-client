...
export class LinkedAccountsClient {
    ...
    private async __list(
        ...
        if (category != null) {
            _queryParams.category = serializers.crm.LinkedAccountsListRequestCategory.jsonOrThrow(category, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /crm/v1/linked-accounts.");
            case "unknown":
                throw new errors.MergeError({

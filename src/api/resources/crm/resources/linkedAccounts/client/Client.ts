...
export class LinkedAccountsClient {
     ...
     *
     * @param {Merge.crm.LinkedAccountsListRequest} request
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.crm.AccountDetailsAndActions, Merge.crm.PaginatedAccountDetailsAndActionsList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Merge.crm.LinkedAccountsListRequest,
            ): Promise<core.WithRawResponse<Merge.crm.PaginatedAccountDetailsAndActionsList>> => {
                const {
                    category,
                    cursor,
                    endUserEmailAddress,
                ...
                const _queryParams: Record<string, unknown> = {
                    category:
                        category != null
                            ? serializers.crm.LinkedAccountsListRequestCategory.jsonOrThrow(category, {
                ...
                if (_response.ok) {
                    return {
                        data: serializers.crm.PaginatedAccountDetailsAndActionsList.parseOrThrow(_response.body, {
        ...
        return new core.Page<Merge.crm.AccountDetailsAndActions, Merge.crm.PaginatedAccountDetailsAndActionsList>({

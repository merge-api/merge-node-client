...
export class Issues {
     ...
     *         status: Merge.crm.IssuesListRequestStatus.Ongoing
     *     })
     */
    public async list(
        ...
        if (_response.ok) {
            return await serializers.crm.PaginatedIssueList.parseOrThrow(_response.body, {
     ...
     *
     * @example
     *     await merge.crm.issues.retrieve("string")
     */
    public async retrieve(id: string, requestOptions?: Issues.RequestOptions): Promise<Merge.crm.Issue> {
        ...
        if (_response.ok) {
            return await serializers.crm.Issue.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],

...
export class Issues {
     ...
     *
     * @param {Merge.crm.IssuesListRequest} request
    ...
    private async __list(
        ...
        if (status != null) {
            _queryParams["status"] = serializers.crm.IssuesListRequestStatus.jsonOrThrow(status, {
     ...
     */
    public retrieve(id: string, requestOptions?: Issues.RequestOptions): core.HttpResponsePromise<Merge.crm.Issue> {

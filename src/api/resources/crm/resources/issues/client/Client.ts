...
export class Issues {
     ...
     *
     * @param {Merge.crm.ListIssuesRequest} request
    ...
    private async __list(
        ...
        if (status != null) {
            _queryParams["status"] = serializers.crm.ListIssuesRequestStatus.jsonOrThrow(status, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /crm/v1/issues.");
            case "unknown":
                throw new errors.MergeError({
     ...
     *
     * @param {string} id
     * @param {Merge.crm.RetrieveIssuesRequest} request
     * @param {Issues.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public retrieve(
        ...
        requestOptions?: Issues.RequestOptions,
    ): core.HttpResponsePromise<Merge.crm.Issue> {
    ...
    private async __retrieve(
        ...
        request: Merge.crm.RetrieveIssuesRequest = {},
        requestOptions?: Issues.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.crm.Issue>> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MergeEnvironment.Production,
                `crm/v1/issues/${encodeURIComponent(id)}`,
            ),
            method: "GET",
            headers: mergeHeaders(
                this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: serializers.crm.Issue.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /crm/v1/issues/{id}.");
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,

...
export interface EndUserDetailsRequest {
    ...
    commonModels?: Merge.crm.CommonModelScopesBodyRequest[] | null;
    /** When creating a Link Token, you can set permissions for Common Models that will apply to the account that is going to be linked. Any model or field not specified in link token payload will default to existing settings. */
    categoryCommonModelScopes?: Record<string, Merge.crm.IndividualCommonModelScopeDeserializerRequest[] | null> | null;
    /**
     ...
     * * `de` - de
     */
    language?: Merge.crm.LanguageEnum | null;
     ...
     */
    completedAccountInitialScreen?: Merge.crm.CompletedAccountInitialScreenEnum | null;

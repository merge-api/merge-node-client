...
export class LinkTokenClient {
    ...
    ): core.HttpResponsePromise<Merge.crm.LinkToken> {
    ...
    private async __create(
        request: Merge.crm.EndUserDetailsRequest,
        requestOptions?: LinkTokenClient.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.crm.LinkToken>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.crm.LinkToken.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling POST /crm/v1/link-token.");
            case "unknown":
                throw new errors.MergeError({

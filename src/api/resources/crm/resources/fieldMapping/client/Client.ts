...
export class FieldMappingClient {
    ...
    private async __fieldMappingsRetrieve(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/crm/v1/field-mappings");
    }
    ...
    private async __fieldMappingsCreate(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/crm/v1/field-mappings");
    }
    ...
    private async __fieldMappingsPartialUpdate(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
            requestType: "json",
            body: serializers.crm.PatchedEditFieldMappingRequest.jsonOrThrow(_body, {
    ...
    private async __remoteFieldsRetrieve(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/crm/v1/remote-fields");
    }
    ...
    private async __targetFieldsRetrieve(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/crm/v1/target-fields");
    }
}

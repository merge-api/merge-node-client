...
export class UsersClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.crm.User, Merge.crm.PaginatedUserList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (request: Merge.crm.UsersListRequest): Promise<core.WithRawResponse<Merge.crm.PaginatedUserList>> => {
                const {
                    createdAfter,
                    createdBefore,
                    cursor,
        ...
        return new core.Page<Merge.crm.User, Merge.crm.PaginatedUserList>({

...
export class AuditTrailClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.crm.AuditLogEvent, Merge.crm.PaginatedAuditLogEventList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/crm/v1/audit-trail");
            },
        );
        const dataWithRawResponse = await list(request).withRawResponse();
        return new core.Page<Merge.crm.AuditLogEvent, Merge.crm.PaginatedAuditLogEventList>({

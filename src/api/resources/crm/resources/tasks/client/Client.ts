...
export class TasksClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.crm.Task, Merge.crm.PaginatedTaskList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (request: Merge.crm.TasksListRequest): Promise<core.WithRawResponse<Merge.crm.PaginatedTaskList>> => {
                const {
                    createdAfter,
                    createdBefore,
                    cursor,
                ...
                const _queryParams: Record<string, unknown> = {
                    ...
                    expand: Array.isArray(expand)
                        ? expand.map((item) =>
                              serializers.crm.TasksListRequestExpandItem.jsonOrThrow(item, {
                                  unrecognizedObjectKeys: "strip",
                              }),
                          )
                        : expand != null
                          ? serializers.crm.TasksListRequestExpandItem.jsonOrThrow(expand, {
                                unrecognizedObjectKeys: "strip",
                            })
                          : undefined,
        ...
        return new core.Page<Merge.crm.Task, Merge.crm.PaginatedTaskList>({

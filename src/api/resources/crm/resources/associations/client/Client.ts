...
export class AssociationsClient {
    ...
    public async customObjectClassesCustomObjectsAssociationsList(
    ...
    ): Promise<core.Page<Merge.crm.Association, Merge.crm.PaginatedAssociationList>> {
        ...
        return new core.Page<Merge.crm.Association, Merge.crm.PaginatedAssociationList>({

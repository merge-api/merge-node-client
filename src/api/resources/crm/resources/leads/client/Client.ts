...
export class LeadsClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.crm.Lead, Merge.crm.PaginatedLeadList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (request: Merge.crm.LeadsListRequest): Promise<core.WithRawResponse<Merge.crm.PaginatedLeadList>> => {
                const {
                    convertedAccountId,
                    convertedContactId,
                    createdAfter,
                ...
                const _queryParams: Record<string, unknown> = {
                    ...
                    expand: Array.isArray(expand)
                        ? expand.map((item) =>
                              serializers.crm.LeadsListRequestExpandItem.jsonOrThrow(item, {
        ...
        return new core.Page<Merge.crm.Lead, Merge.crm.PaginatedLeadList>({

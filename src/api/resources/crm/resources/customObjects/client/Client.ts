...
export class CustomObjects {
     ...
     */
    public async customObjectClassesCustomObjectsPartialUpdate(
        customObjectClassId: string,
        id: string,
        request: Merge.crm.PatchedCrmCustomObjectEndpointRequest,
        requestOptions?: CustomObjects.RequestOptions
    ): Promise<Merge.crm.CrmCustomObjectResponse> {
        const { isDebugMode, runAsync, ..._body } = request;
        const _queryParams = new URLSearchParams();
        ...
        const _response = await core.fetcher({
            ...
            contentType: "application/json",
            queryParameters: _queryParams,
            body: await serializers.crm.PatchedCrmCustomObjectEndpointRequest.jsonOrThrow(_body, {
                unrecognizedObjectKeys: "strip",
            }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
        });

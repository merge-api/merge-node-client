...
export class AssociationTypes {
     ...
     * @param {Merge.crm.CustomObjectClassesAssociationTypesListAssociationTypesRequest} request
    ...
    /**
     * Creates an `AssociationType` object with the given values.{/* BEGIN_CRM_CUSTOMOBJECTCLASS_CREATE_SUPPORTED_FIELDS * /}{/* END_CRM_CUSTOMOBJECTCLASS_CREATE_SUPPORTED_FIELDS * /}
     *
     * @param {string} customObjectClassId
    ...
    /**
     * Returns an `AssociationType` object with the given `id`.{/* BEGIN_CRM_CUSTOMOBJECTCLASS_FETCH_SUPPORTED_FIELDS * /}<Footer><MergeSupportedFieldsByIntegrationWidget requestType="GET" data="" /></Footer>{/* END_CRM_CUSTOMOBJECTCLASS_FETCH_SUPPORTED_FIELDS * /}
     *
     * @param {string} customObjectClassId
     * @param {string} id
     * @param {Merge.crm.CustomObjectClassesAssociationTypesRetrieveAssociationTypesRequest} request
     * @param {AssociationTypes.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {string} customObjectClassId
     * @param {Merge.crm.CustomObjectClassesAssociationTypesMetaPostRetrieveAssociationTypesRequest} request
     * @param {AssociationTypes.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public customObjectClassesAssociationTypesMetaPostRetrieve(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__customObjectClassesAssociationTypesMetaPostRetrieve(customObjectClassId, request, requestOptions),
        );
    }

...
export class AssociationTypesClient {
    ...
    public async customObjectClassesAssociationTypesList(
    ...
    ): Promise<core.Page<Merge.crm.AssociationType, Merge.crm.PaginatedAssociationTypeList>> {
        ...
        return new core.Page<Merge.crm.AssociationType, Merge.crm.PaginatedAssociationTypeList>({

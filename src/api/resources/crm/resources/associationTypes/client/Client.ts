...
export class AssociationTypes {
    ...
    public async customObjectClassesAssociationTypesList(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `custom-object-classes/${customObjectClassId}/association-types`
            ),
            method: "GET",
            headers: {
    ...
    public async customObjectClassesAssociationTypesRetrieve(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MergeEnvironment.Production,
                `custom-object-classes/${customObjectClassId}/association-types/${id}`
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
    ...
    public async customObjectClassesAssociationTypesMetaPostRetrieve(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MergeEnvironment.Production,
                `custom-object-classes/${customObjectClassId}/association-types/meta/post`
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),

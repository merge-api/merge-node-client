...
export class LinkTokenClient {
     ...
     *
     * @param {Merge.chat.EndUserDetailsRequest} request
    ...
    ): core.HttpResponsePromise<Merge.chat.LinkToken> {
    ...
    private async __create(
        request: Merge.chat.EndUserDetailsRequest,
        requestOptions?: LinkTokenClient.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.chat.LinkToken>> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.chat.EndUserDetailsRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
        ...
        if (_response.ok) {
            return {
                data: serializers.chat.LinkToken.parseOrThrow(_response.body, {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/chat/v1/link-token");
    }
}

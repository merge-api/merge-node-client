...
export interface EndUserDetailsRequest {
    ...
    categories: Merge.chat.CategoriesEnum[];
    ...
    commonModels?: Merge.chat.CommonModelScopesBodyRequest[];
    /** When creating a Link Token, you can set permissions for Common Models that will apply to the account that is going to be linked. Any model or field not specified in link token payload will default to existing settings. */
    categoryCommonModelScopes?: Record<string, Merge.chat.IndividualCommonModelScopeDeserializerRequest[] | undefined>;
    /**
     ...
     * * `de` - de
     */
    language?: Merge.chat.EndUserDetailsRequestLanguage;
     ...
     */
    completedAccountInitialScreen?: Merge.chat.EndUserDetailsRequestCompletedAccountInitialScreen;
}

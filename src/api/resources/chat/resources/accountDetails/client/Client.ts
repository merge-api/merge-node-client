...
export class AccountDetailsClient {
    ...
    ): core.HttpResponsePromise<Merge.chat.AccountDetails> {
        return core.HttpResponsePromise.fromPromise(this.__retrieve(requestOptions));
    }

    private async __retrieve(
        requestOptions?: AccountDetailsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.chat.AccountDetails>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.chat.AccountDetails.parseOrThrow(_response.body, {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/chat/v1/account-details");
    }
}

...
export class ScopesClient {
    ...
    ): core.HttpResponsePromise<Merge.chat.CommonModelScopeApi> {
    ...
    private async __defaultScopesRetrieve(
        requestOptions?: ScopesClient.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.chat.CommonModelScopeApi>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.chat.CommonModelScopeApi.parseOrThrow(_response.body, {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/chat/v1/default-scopes");
    }
     ...
     *
     * @param {Merge.chat.LinkedAccountCommonModelScopeDeserializerRequest} request
     * @param {ScopesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    private async __linkedAccountScopesCreate(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.chat.LinkedAccountCommonModelScopeDeserializerRequest.jsonOrThrow(request, {

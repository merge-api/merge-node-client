...
export class AvailableActionsClient {
    ...
    ): core.HttpResponsePromise<Merge.chat.AvailableActions> {
        return core.HttpResponsePromise.fromPromise(this.__retrieve(requestOptions));
    }

    private async __retrieve(
        requestOptions?: AvailableActionsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.chat.AvailableActions>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.chat.AvailableActions.parseOrThrow(_response.body, {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/chat/v1/available-actions");
    }
}

...
export class AccountTokenClient {
    ...
    ): core.HttpResponsePromise<Merge.chat.AccountToken> {
    ...
    private async __retrieve(
        public_token: string,
        requestOptions?: AccountTokenClient.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.chat.AccountToken>> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `chat/v1/account-token/${core.url.encodePathParam(public_token)}`,
            ),
            method: "GET",
            headers: _headers,
        ...
        if (_response.ok) {
            return {
                data: serializers.chat.AccountToken.parseOrThrow(_response.body, {
        ...
        return handleNonStatusCodeError(
            ...
            "GET",
            "/chat/v1/account-token/{public_token}",
        );
    }
}

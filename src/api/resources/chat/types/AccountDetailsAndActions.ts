...
export interface AccountDetailsAndActions {
    id: string;
    category?: Merge.chat.AccountDetailsAndActionsCategory;
    status: Merge.chat.AccountDetailsAndActionsStatus;
    statusDetail?: string;
    ...
    isDuplicate?: boolean;
    integration?: Merge.chat.AccountDetailsAndActionsIntegration;
    accountType: string;
    completedAt: Date;

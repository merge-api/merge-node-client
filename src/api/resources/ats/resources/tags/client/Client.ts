...
export class TagsClient {
    ...
    ): Promise<core.Page<Merge.ats.Tag, Merge.ats.PaginatedTagList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (request: Merge.ats.TagsListRequest): Promise<core.WithRawResponse<Merge.ats.PaginatedTagList>> => {
                const {
                    createdAfter,
                    createdBefore,
                    cursor,
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ats/v1/tags");
            },
        );
        const dataWithRawResponse = await list(request).withRawResponse();
        return new core.Page<Merge.ats.Tag, Merge.ats.PaginatedTagList>({

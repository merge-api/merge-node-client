...
export class LinkedAccounts {
     ...
     *
     * @example
     *     await merge.ats.linkedAccounts.list({
     *         category: Merge.ats.LinkedAccountsListRequestCategory.Accounting
     *     })
     */
    public async list(
        ...
        if (_response.ok) {
            return await serializers.ats.PaginatedAccountDetailsAndActionsList.parseOrThrow(_response.body, {

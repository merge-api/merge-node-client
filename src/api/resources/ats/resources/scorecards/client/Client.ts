...
export class Scorecards {
    ...
    public async list(
        ...
        if (interviewId != null) {
            _queryParams.append("interview_id", interviewId);
        }

        if (interviewerId != null) {
            _queryParams.append("interviewer_id", interviewerId);
        }
        ...
        if (_response.ok) {
            return await serializers.ats.PaginatedScorecardList.parseOrThrow(_response.body, {
    ...
    public async retrieve(
        ...
        if (_response.ok) {
            return await serializers.ats.Scorecard.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],

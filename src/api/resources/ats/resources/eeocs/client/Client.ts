...
export class EeocsClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.ats.Eeoc, Merge.ats.PaginatedEeocList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (request: Merge.ats.EeocsListRequest): Promise<core.WithRawResponse<Merge.ats.PaginatedEeocList>> => {
                const {
                    candidateId,
                    createdAfter,
                    createdBefore,
        ...
        return new core.Page<Merge.ats.Eeoc, Merge.ats.PaginatedEeocList>({

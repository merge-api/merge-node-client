...
export class LinkTokenClient {
    ...
    ): core.HttpResponsePromise<Merge.ats.LinkToken> {
    ...
    private async __create(
        request: Merge.ats.EndUserDetailsRequest,
        requestOptions?: LinkTokenClient.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.ats.LinkToken>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.ats.LinkToken.parseOrThrow(_response.body, {

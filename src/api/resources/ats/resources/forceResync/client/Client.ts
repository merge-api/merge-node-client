...
export class ForceResync {
     ...
     */
    public async syncStatusResyncCreate(requestOptions?: ForceResync.RequestOptions): Promise<Merge.ats.SyncStatus[]> {
        ...
        if (_response.ok) {
            return serializers.ats.forceResync.syncStatusResyncCreate.Response.parseOrThrow(_response.body, {

...
export class ForceResyncClient {
    ...
    ): core.HttpResponsePromise<Merge.ats.SyncStatus[]> {
    ...
    private async __syncStatusResyncCreate(
        requestOptions?: ForceResyncClient.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.ats.SyncStatus[]>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.ats.forceResync.syncStatusResyncCreate.Response.parseOrThrow(_response.body, {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/ats/v1/sync-status/resync");
    }
}

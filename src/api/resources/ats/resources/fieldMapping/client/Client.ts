...
export class FieldMapping {
    ...
    ): core.HttpResponsePromise<Merge.ats.FieldMappingApiInstanceResponse> {
    ...
    private async __fieldMappingsRetrieve(
        request: Merge.ats.FieldMappingsRetrieveFieldMappingRequest = {},
        requestOptions?: FieldMapping.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.ats.FieldMappingApiInstanceResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.ats.FieldMappingApiInstanceResponse.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /ats/v1/field-mappings.");
            case "unknown":
                throw new errors.MergeError({
     ...
     *
     * @param {Merge.ats.CreateFieldMappingRequest} request
     * @param {FieldMapping.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public fieldMappingsCreate(
        ...
        requestOptions?: FieldMapping.RequestOptions,
    ): core.HttpResponsePromise<Merge.ats.FieldMappingInstanceResponse> {
    ...
    private async __fieldMappingsCreate(
        request: Merge.ats.CreateFieldMappingRequest,
        requestOptions?: FieldMapping.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.ats.FieldMappingInstanceResponse>> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
            requestType: "json",
            body: serializers.ats.CreateFieldMappingRequest.jsonOrThrow(_body, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        if (_response.ok) {
            return {
                data: serializers.ats.FieldMappingInstanceResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling POST /ats/v1/field-mappings.");
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     * @param {Merge.ats.FieldMappingsDestroyFieldMappingRequest} request
     * @param {FieldMapping.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MergeEnvironment.Production,
                `ats/v1/field-mappings/${encodeURIComponent(fieldMappingId)}`,
            ),
            method: "DELETE",
            headers: mergeHeaders(
                this._options?.headers,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError(
                    "Timeout exceeded when calling DELETE /ats/v1/field-mappings/{field_mapping_id}.",
                );
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,
     ...
     *
     * @param {string} fieldMappingId
     * @param {Merge.ats.PatchedEditFieldMappingRequest} request
     * @param {FieldMapping.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    private async __fieldMappingsPartialUpdate(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError(
                    "Timeout exceeded when calling PATCH /ats/v1/field-mappings/{field_mapping_id}.",
                );
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,
     ...
     *
     * @param {Merge.ats.RemoteFieldsRetrieveFieldMappingRequest} request
     * @param {FieldMapping.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public remoteFieldsRetrieve(
        ...
        requestOptions?: FieldMapping.RequestOptions,
    ): core.HttpResponsePromise<Merge.ats.RemoteFieldApiResponse> {
    ...
    private async __remoteFieldsRetrieve(
        request: Merge.ats.RemoteFieldsRetrieveFieldMappingRequest = {},
        requestOptions?: FieldMapping.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.ats.RemoteFieldApiResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.ats.RemoteFieldApiResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /ats/v1/remote-fields.");
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    public targetFieldsRetrieve(
        requestOptions?: FieldMapping.RequestOptions,
    ): core.HttpResponsePromise<Merge.ats.ExternalTargetFieldApiResponse> {
    ...
    private async __targetFieldsRetrieve(
        requestOptions?: FieldMapping.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.ats.ExternalTargetFieldApiResponse>> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return {
                data: serializers.ats.ExternalTargetFieldApiResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /ats/v1/target-fields.");
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,

...
export class JobInterviewStages {
    ...
    public async list(
        ...
        if (_response.ok) {
            return await serializers.ats.PaginatedJobInterviewStageList.parseOrThrow(_response.body, {
    ...
    public async retrieve(
        ...
        if (_response.ok) {
            return await serializers.ats.JobInterviewStage.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],

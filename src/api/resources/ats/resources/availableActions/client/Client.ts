...
export class AvailableActions {
    ...
    ): core.HttpResponsePromise<Merge.ats.AvailableActions> {
        return core.HttpResponsePromise.fromPromise(this.__retrieve(requestOptions));
    }

    private async __retrieve(
        requestOptions?: AvailableActions.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.ats.AvailableActions>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.ats.AvailableActions.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /ats/v1/available-actions.");
            case "unknown":
                throw new errors.MergeError({

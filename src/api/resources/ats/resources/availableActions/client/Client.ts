...
export class AvailableActions {
     ...
     */
    public async retrieve(requestOptions?: AvailableActions.RequestOptions): Promise<Merge.ats.AvailableActions> {
        ...
        if (_response.ok) {
            return serializers.ats.AvailableActions.parseOrThrow(_response.body, {

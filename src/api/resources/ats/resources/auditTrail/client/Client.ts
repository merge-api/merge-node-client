...
export class AuditTrailClient {
     ...
     *
     * @param {Merge.ats.AuditTrailListRequest} request
    ...
    ): Promise<core.Page<Merge.ats.AuditLogEvent, Merge.ats.PaginatedAuditLogEventList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Merge.ats.AuditTrailListRequest,
            ): Promise<core.WithRawResponse<Merge.ats.PaginatedAuditLogEventList>> => {
                ...
                if (_response.ok) {
                    return {
                        data: serializers.ats.PaginatedAuditLogEventList.parseOrThrow(_response.body, {
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ats/v1/audit-trail");
            },
        );
        const dataWithRawResponse = await list(request).withRawResponse();
        return new core.Page<Merge.ats.AuditLogEvent, Merge.ats.PaginatedAuditLogEventList>({

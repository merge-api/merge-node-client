...
export class IssuesClient {
     ...
     *
     * @param {Merge.ticketing.IssuesListRequest} request
    ...
    ): Promise<core.Page<Merge.ticketing.Issue, Merge.ticketing.PaginatedIssueList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const _queryParams: Record<string, unknown> = {
                    ...
                    status:
                        status != null
                            ? serializers.ticketing.IssuesListRequestStatus.jsonOrThrow(status, {
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ticketing/v1/issues");
            },
        );
        const dataWithRawResponse = await list(request).withRawResponse();
        return new core.Page<Merge.ticketing.Issue, Merge.ticketing.PaginatedIssueList>({
    ...
    private async __retrieve(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MergeEnvironment.Production,
                `ticketing/v1/issues/${core.url.encodePathParam(id)}`,
            ),
            method: "GET",
            headers: _headers,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ticketing/v1/issues/{id}");
    }
}

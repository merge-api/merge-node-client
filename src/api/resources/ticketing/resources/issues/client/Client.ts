...
export class Issues {
    ...
    public async list(
    ...
    ): Promise<Merge.ticketing.PaginatedIssueList> {
        const {
            accountToken,
            cursor,
            endDate,
        ...
        if (_response.ok) {
            return serializers.ticketing.PaginatedIssueList.parseOrThrow(_response.body, {
     ...
     */
    public async retrieve(id: string, requestOptions?: Issues.RequestOptions): Promise<Merge.ticketing.Issue> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MergeEnvironment.Production,
        ...
        if (_response.ok) {
            return serializers.ticketing.Issue.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,

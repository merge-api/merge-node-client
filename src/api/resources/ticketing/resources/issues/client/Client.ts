...
export class Issues {
     ...
     *
     * @example
     *     await merge.ticketing.issues.list({
    ...
    public async list(
        ...
        if (_response.ok) {
            return await serializers.ticketing.PaginatedIssueList.parseOrThrow(_response.body, {
    ...
    public async retrieve(id: string, requestOptions?: Issues.RequestOptions): Promise<Merge.ticketing.Issue> {
        ...
        if (_response.ok) {
            return await serializers.ticketing.Issue.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],

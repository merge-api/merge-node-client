...
export class Comments {
    ...
    public async create(
        ...
        const _response = await core.fetcher({
            ...
            contentType: "application/json",
            queryParameters: _queryParams,
            body: await serializers.ticketing.CommentEndpointRequest.jsonOrThrow(_body, {
     ...
     *
     * @example
     *     await merge.ticketing.comments.retrieve("string", {
    ...
    public async metaPostRetrieve(requestOptions?: Comments.RequestOptions): Promise<Merge.ticketing.MetaResponse> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MergeEnvironment.Production,
                "api/ticketing/v1/comments/meta/post"
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),

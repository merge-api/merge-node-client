...
export class DeleteAccountClient {
    protected readonly _options: DeleteAccountClient.Options;
    ...
    private async __delete(requestOptions?: DeleteAccountClient.RequestOptions): Promise<core.WithRawResponse<void>> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling POST /ticketing/v1/delete-account.");
            case "unknown":
                throw new errors.MergeError({

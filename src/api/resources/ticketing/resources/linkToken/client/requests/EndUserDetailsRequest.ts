...
export interface EndUserDetailsRequest {
    ...
    categoryCommonModelScopes?: Record<
        string,
        Merge.ticketing.IndividualCommonModelScopeDeserializerRequest[] | undefined
    >;
    /**
     ...
     * * `de` - de
     */
    language?: Merge.ticketing.EndUserDetailsRequestLanguage;
     ...
     */
    completedAccountInitialScreen?: Merge.ticketing.EndUserDetailsRequestCompletedAccountInitialScreen;
}

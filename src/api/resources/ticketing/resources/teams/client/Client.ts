...
export class TeamsClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.ticketing.Team, Merge.ticketing.PaginatedTeamList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ticketing/v1/teams");
            },
        );
        const dataWithRawResponse = await list(request).withRawResponse();
        return new core.Page<Merge.ticketing.Team, Merge.ticketing.PaginatedTeamList>({
    ...
    private async __retrieve(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MergeEnvironment.Production,
                `ticketing/v1/teams/${core.url.encodePathParam(id)}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ticketing/v1/teams/{id}");
    }
}

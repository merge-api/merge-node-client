...
export class TagsClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.ticketing.Tag, Merge.ticketing.PaginatedTagList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ticketing/v1/tags");
            },
        );
        const dataWithRawResponse = await list(request).withRawResponse();
        return new core.Page<Merge.ticketing.Tag, Merge.ticketing.PaginatedTagList>({
    ...
    private async __retrieve(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ticketing/v1/tags/{id}");
    }
}

...
export class UsersClient {
    ...
    private async __list(
        ...
        if (expand != null) {
            _queryParams.expand = serializers.ticketing.UsersListRequestExpand.jsonOrThrow(expand, {
    ...
    private async __retrieve(
        ...
        const _queryParams: Record<string, string | string[] | object | object[] | null> = {};
        if (expand != null) {
            _queryParams.expand = serializers.ticketing.UsersRetrieveRequestExpand.jsonOrThrow(expand, {
                unrecognizedObjectKeys: "strip",
            });
        }

...
export class FieldMapping {
    ...
    ): core.HttpResponsePromise<Merge.ticketing.FieldMappingApiInstanceResponse> {
    ...
    private async __fieldMappingsRetrieve(
        request: Merge.ticketing.FieldMappingsRetrieveFieldMappingRequest = {},
        requestOptions?: FieldMapping.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.ticketing.FieldMappingApiInstanceResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.ticketing.FieldMappingApiInstanceResponse.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /ticketing/v1/field-mappings.");
            case "unknown":
                throw new errors.MergeError({
     ...
     *
     * @param {Merge.ticketing.CreateFieldMappingRequest} request
     * @param {FieldMapping.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public fieldMappingsCreate(
        ...
        requestOptions?: FieldMapping.RequestOptions,
    ): core.HttpResponsePromise<Merge.ticketing.FieldMappingInstanceResponse> {
    ...
    private async __fieldMappingsCreate(
        request: Merge.ticketing.CreateFieldMappingRequest,
        requestOptions?: FieldMapping.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.ticketing.FieldMappingInstanceResponse>> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
            requestType: "json",
            body: serializers.ticketing.CreateFieldMappingRequest.jsonOrThrow(_body, {
        ...
        if (_response.ok) {
            return {
                data: serializers.ticketing.FieldMappingInstanceResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling POST /ticketing/v1/field-mappings.");
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     * @param {Merge.ticketing.FieldMappingsDestroyFieldMappingRequest} request
     * @param {FieldMapping.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public fieldMappingsDestroy(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__fieldMappingsDestroy(fieldMappingId, request, requestOptions),
        );
    }
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MergeEnvironment.Production,
                `ticketing/v1/field-mappings/${encodeURIComponent(fieldMappingId)}`,
            ),
            method: "DELETE",
            headers: mergeHeaders(
                this._options?.headers,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError(
                    "Timeout exceeded when calling DELETE /ticketing/v1/field-mappings/{field_mapping_id}.",
                );
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,
     ...
     *
     * @param {string} fieldMappingId
     * @param {Merge.ticketing.PatchedEditFieldMappingRequest} request
     * @param {FieldMapping.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    private async __fieldMappingsPartialUpdate(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError(
                    "Timeout exceeded when calling PATCH /ticketing/v1/field-mappings/{field_mapping_id}.",
                );
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,
     ...
     *
     * @param {Merge.ticketing.RemoteFieldsRetrieveFieldMappingRequest} request
     * @param {FieldMapping.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public remoteFieldsRetrieve(
        ...
        requestOptions?: FieldMapping.RequestOptions,
    ): core.HttpResponsePromise<Merge.ticketing.RemoteFieldApiResponse> {
    ...
    private async __remoteFieldsRetrieve(
        request: Merge.ticketing.RemoteFieldsRetrieveFieldMappingRequest = {},
        requestOptions?: FieldMapping.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.ticketing.RemoteFieldApiResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.ticketing.RemoteFieldApiResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /ticketing/v1/remote-fields.");
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    public targetFieldsRetrieve(
        requestOptions?: FieldMapping.RequestOptions,
    ): core.HttpResponsePromise<Merge.ticketing.ExternalTargetFieldApiResponse> {
    ...
    private async __targetFieldsRetrieve(
        requestOptions?: FieldMapping.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.ticketing.ExternalTargetFieldApiResponse>> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return {
                data: serializers.ticketing.ExternalTargetFieldApiResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /ticketing/v1/target-fields.");
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,

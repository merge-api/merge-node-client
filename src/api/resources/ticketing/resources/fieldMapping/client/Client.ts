...
export class FieldMapping {
     ...
     *
     * @example
     *     await merge.ticketing.fieldMapping.fieldMappingsDestroy("string")
     */
    public async fieldMappingsDestroy(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MergeEnvironment.Production,
                `api/ticketing/v1/field-mappings/${fieldMappingId}`
            ),
            method: "DELETE",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
     ...
     *
     * @example
     *     await merge.ticketing.fieldMapping.fieldMappingsPartialUpdate("string", {
     *         remoteMethod: "GET",
     *         remoteUrlPath: "/example-url-path"
     *     })
     */
    ...
    public async remoteFieldsRetrieve(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MergeEnvironment.Production,
                "api/ticketing/v1/remote-fields"
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),

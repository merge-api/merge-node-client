...
export class FieldMapping {
    ...
    public async fieldMappingsRetrieve(
        ...
        if (_response.ok) {
            return serializers.ticketing.FieldMappingApiInstanceResponse.parseOrThrow(_response.body, {
    ...
    public async fieldMappingsCreate(
        ...
        if (_response.ok) {
            return serializers.ticketing.FieldMappingInstanceResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
    ...
    public async remoteFieldsRetrieve(
        ...
        if (_response.ok) {
            return serializers.ticketing.RemoteFieldApiResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
    ...
    public async targetFieldsRetrieve(
        ...
        if (_response.ok) {
            return serializers.ticketing.ExternalTargetFieldApiResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,

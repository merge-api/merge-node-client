...
export class FieldMappingClient {
     ...
     *
     * @param {Merge.ticketing.FieldMappingsRetrieveRequest} request
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MergeEnvironment.Production,
                `ticketing/v1/field-mappings/${core.url.encodePathParam(field_mapping_id)}`,
            ),
            method: "DELETE",
            headers: _headers,
     ...
     *
     * @param {Merge.ticketing.RemoteFieldsRetrieveRequest} request
     * @param {FieldMappingClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example

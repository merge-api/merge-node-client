...
export class FieldMappingClient {
    ...
    private async __fieldMappingsRetrieve(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ticketing/v1/field-mappings");
    }
    ...
    private async __fieldMappingsCreate(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/ticketing/v1/field-mappings");
    }
    ...
    private async __fieldMappingsDestroy(
        ...
        return handleNonStatusCodeError(
            ...
            "DELETE",
            "/ticketing/v1/field-mappings/{field_mapping_id}",
        );
    }
    ...
    private async __fieldMappingsPartialUpdate(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
            requestType: "json",
            body: serializers.ticketing.PatchedEditFieldMappingRequest.jsonOrThrow(_body, {
                unrecognizedObjectKeys: "strip",
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
    ...
    private async __remoteFieldsRetrieve(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ticketing/v1/remote-fields");
    }
    ...
    private async __targetFieldsRetrieve(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ticketing/v1/target-fields");
    }
}

...
export class LinkedAccountsClient {
    protected readonly _options: LinkedAccountsClient.Options;
    ...
    private async __list(
        ...
        if (category != null) {
            _queryParams.category = serializers.ticketing.LinkedAccountsListRequestCategory.jsonOrThrow(category, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /ticketing/v1/linked-accounts.");
            case "unknown":
                throw new errors.MergeError({

...
export class LinkedAccounts {
     ...
     *
     * @param {Merge.ticketing.ListLinkedAccountsRequest} request
    ...
    private async __list(
        ...
        if (category !== undefined) {
            _queryParams["category"] = serializers.ticketing.ListLinkedAccountsRequestCategory.jsonOrThrow(category, {

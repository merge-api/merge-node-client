...
export class AvailableActions {
    ...
    ): core.HttpResponsePromise<Merge.ticketing.AvailableActions> {
        return core.HttpResponsePromise.fromPromise(this.__retrieve(requestOptions));
    }

    private async __retrieve(
        requestOptions?: AvailableActions.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.ticketing.AvailableActions>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.ticketing.AvailableActions.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError(
                    "Timeout exceeded when calling GET /ticketing/v1/available-actions.",
                );
            case "unknown":
                throw new errors.MergeError({

...
export class AsyncPassthrough {
    ...
    public async create(
        ...
        if (_response.ok) {
            return serializers.ticketing.AsyncPassthroughReciept.parseOrThrow(_response.body, {
    ...
    public async retrieve(
        ...
        requestOptions?: AsyncPassthrough.RequestOptions
    ): Promise<Merge.ticketing.AsyncPassthroughRetrieveResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MergeEnvironment.Production,
        ...
        if (_response.ok) {
            return serializers.ticketing.AsyncPassthroughRetrieveResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,

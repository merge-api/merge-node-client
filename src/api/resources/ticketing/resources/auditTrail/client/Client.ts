...
export class AuditTrailClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.ticketing.AuditLogEvent, Merge.ticketing.PaginatedAuditLogEventList>> {
        ...
        return new core.Page<Merge.ticketing.AuditLogEvent, Merge.ticketing.PaginatedAuditLogEventList>({

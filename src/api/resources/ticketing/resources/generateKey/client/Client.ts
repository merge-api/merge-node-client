...
export class GenerateKeyClient {
     ...
     * Create a remote key.
     *
     * @param {Merge.ticketing.GenerateRemoteKeyRequest} request
    ...
    private async __create(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/ticketing/v1/generate-key");
    }
}

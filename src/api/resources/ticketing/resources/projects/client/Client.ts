...
export class Projects {
    ...
    public async list(
        ...
        if (_response.ok) {
            return await serializers.ticketing.PaginatedProjectList.parseOrThrow(_response.body, {
    ...
    public async retrieve(
        ...
        if (_response.ok) {
            return await serializers.ticketing.Project.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],
     ...
     *
     * @example
     *     await merge.ticketing.projects.usersList("parent-id", {

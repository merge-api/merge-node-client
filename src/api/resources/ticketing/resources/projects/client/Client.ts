...
export class ProjectsClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.ticketing.Project, Merge.ticketing.PaginatedProjectList>> {
        ...
        return new core.Page<Merge.ticketing.Project, Merge.ticketing.PaginatedProjectList>({

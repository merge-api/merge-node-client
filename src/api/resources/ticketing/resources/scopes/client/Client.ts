...
export class Scopes {
    ...
    ): core.HttpResponsePromise<Merge.ticketing.CommonModelScopeApi> {
    ...
    private async __defaultScopesRetrieve(
        requestOptions?: Scopes.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.ticketing.CommonModelScopeApi>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.ticketing.CommonModelScopeApi.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /ticketing/v1/default-scopes.");
            case "unknown":
                throw new errors.MergeError({
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError(
                    "Timeout exceeded when calling GET /ticketing/v1/linked-account-scopes.",
                );
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,
     ...
     *
     * @param {Merge.ticketing.LinkedAccountCommonModelScopeDeserializerRequest} request
     * @param {Scopes.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    private async __linkedAccountScopesCreate(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError(
                    "Timeout exceeded when calling POST /ticketing/v1/linked-account-scopes.",
                );
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,

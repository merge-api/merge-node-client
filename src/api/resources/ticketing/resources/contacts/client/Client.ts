...
export class ContactsClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.ticketing.Contact, Merge.ticketing.PaginatedContactList>> {
        ...
        return new core.Page<Merge.ticketing.Contact, Merge.ticketing.PaginatedContactList>({

...
export interface DataPassthroughRequest {
    method: Merge.knowledgebase.DataPassthroughRequestMethod;
    ...
    multipartFormData?: Merge.knowledgebase.MultipartFormFieldRequest[];
    /** The headers to use for the request (Merge will handle the account's authorization headers). `Content-Type` header is required for passthrough. Choose content type corresponding to expected format of receiving server. */
    headers?: Record<string, unknown>;
    requestFormat?: Merge.knowledgebase.DataPassthroughRequestRequestFormat;

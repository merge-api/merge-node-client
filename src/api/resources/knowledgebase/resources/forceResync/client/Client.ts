...
export class ForceResyncClient {
    ...
    ): core.HttpResponsePromise<Merge.knowledgebase.SyncStatus[]> {
    ...
    private async __syncStatusResyncCreate(
        requestOptions?: ForceResyncClient.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.knowledgebase.SyncStatus[]>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.knowledgebase.forceResync.syncStatusResyncCreate.Response.parseOrThrow(
                    _response.body,
                    {

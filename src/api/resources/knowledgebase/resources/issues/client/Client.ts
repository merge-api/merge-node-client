...
export class Issues {
    ...
    private async __list(
        ...
        if (status != null) {
            _queryParams["status"] = serializers.knowledgebase.IssuesListRequestStatus.jsonOrThrow(status, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /knowledgebase/v1/issues.");
            case "unknown":
                throw new errors.MergeError({
    ...
    private async __retrieve(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MergeEnvironment.Production,
                `knowledgebase/v1/issues/${encodeURIComponent(id)}`,
            ),
            method: "GET",
            headers: _headers,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError("Timeout exceeded when calling GET /knowledgebase/v1/issues/{id}.");
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,

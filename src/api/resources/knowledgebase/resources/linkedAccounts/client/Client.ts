...
export class LinkedAccounts {
    ...
    private async __list(
        ...
        if (category != null) {
            _queryParams["category"] = serializers.knowledgebase.LinkedAccountsListRequestCategory.jsonOrThrow(
                category,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError(
                    "Timeout exceeded when calling GET /knowledgebase/v1/linked-accounts.",
                );
            case "unknown":
                throw new errors.MergeError({

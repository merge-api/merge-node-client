...
export interface EndUserDetailsRequest {
    ...
    commonModels?: Merge.knowledgebase.CommonModelScopesBodyRequest[];
    /** When creating a Link Token, you can set permissions for Common Models that will apply to the account that is going to be linked. Any model or field not specified in link token payload will default to existing settings. */
    categoryCommonModelScopes?: Record<
        string,
        Merge.knowledgebase.IndividualCommonModelScopeDeserializerRequest[] | undefined
    >;
    /**
     ...
     * * `de` - de
     */
    language?: Merge.knowledgebase.EndUserDetailsRequestLanguage;
     ...
     */
    completedAccountInitialScreen?: Merge.knowledgebase.EndUserDetailsRequestCompletedAccountInitialScreen;
}

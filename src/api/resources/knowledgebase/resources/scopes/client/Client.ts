...
export class Scopes {
    ...
    ): core.HttpResponsePromise<Merge.knowledgebase.CommonModelScopeApi> {
    ...
    private async __defaultScopesRetrieve(
        requestOptions?: Scopes.RequestOptions,
    ): Promise<core.WithRawResponse<Merge.knowledgebase.CommonModelScopeApi>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.knowledgebase.CommonModelScopeApi.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError(
                    "Timeout exceeded when calling GET /knowledgebase/v1/default-scopes.",
                );
            case "unknown":
                throw new errors.MergeError({
    ...
    private async __linkedAccountScopesRetrieve(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError(
                    "Timeout exceeded when calling GET /knowledgebase/v1/linked-account-scopes.",
                );
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,
     ...
     *
     * @param {Merge.knowledgebase.LinkedAccountCommonModelScopeDeserializerRequest} request
     * @param {Scopes.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    private async __linkedAccountScopesCreate(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.knowledgebase.LinkedAccountCommonModelScopeDeserializerRequest.jsonOrThrow(request, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MergeTimeoutError(
                    "Timeout exceeded when calling POST /knowledgebase/v1/linked-account-scopes.",
                );
            case "unknown":
                throw new errors.MergeError({
                    message: _response.error.errorMessage,

...
export class PayrollRunsClient {
    protected readonly _options: PayrollRunsClient.Options;
    ...
    private async __list(
        ...
        if (remoteFields != null) {
            _queryParams.remote_fields = serializers.hris.PayrollRunsListRequestRemoteFields.jsonOrThrow(remoteFields, {

...
export class PayrollRunsClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.hris.PayrollRun, Merge.hris.PaginatedPayrollRunList>> {
        ...
        return new core.Page<Merge.hris.PayrollRun, Merge.hris.PaginatedPayrollRunList>({

...
export class Companies {
    ...
    public async list(
        ...
        if (_response.ok) {
            return await serializers.hris.PaginatedCompanyList.parseOrThrow(_response.body, {
     ...
     *
     * @example
     *     await merge.hris.companies.retrieve("string", {})
     */
    public async retrieve(
        ...
        if (_response.ok) {
            return await serializers.hris.Company.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],

...
export class AuditTrailClient {
     ...
     *
     * @param {Merge.hris.AuditTrailListRequest} request
    ...
    ): Promise<core.Page<Merge.hris.AuditLogEvent, Merge.hris.PaginatedAuditLogEventList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Merge.hris.AuditTrailListRequest,
            ): Promise<core.WithRawResponse<Merge.hris.PaginatedAuditLogEventList>> => {
                ...
                if (_response.ok) {
                    return {
                        data: serializers.hris.PaginatedAuditLogEventList.parseOrThrow(_response.body, {
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/hris/v1/audit-trail");
            },
        );
        const dataWithRawResponse = await list(request).withRawResponse();
        return new core.Page<Merge.hris.AuditLogEvent, Merge.hris.PaginatedAuditLogEventList>({

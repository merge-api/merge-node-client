...
export class FieldMapping {
    ...
    ): Promise<Merge.hris.FieldMappingApiInstanceResponse> {
    ...
    public async fieldMappingsCreate(
        ...
        requestOptions?: FieldMapping.RequestOptions
    ): Promise<Merge.hris.FieldMappingInstanceResponse> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MergeEnvironment.Production,
                "api/hris/v1/field-mappings"
     ...
     *
     * @example
     *     await merge.hris.fieldMapping.fieldMappingsDestroy("string")
     */
    public async fieldMappingsDestroy(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MergeEnvironment.Production,
                `api/hris/v1/field-mappings/${fieldMappingId}`
            ),
            method: "DELETE",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
     ...
     *
     * @example
     *     await merge.hris.fieldMapping.fieldMappingsPartialUpdate("string", {
     *         remoteMethod: "GET",
     *         remoteUrlPath: "/example-url-path"
     *     })
     */
    ...
    public async targetFieldsRetrieve(
        requestOptions?: FieldMapping.RequestOptions
    ): Promise<Merge.hris.ExternalTargetFieldApiResponse> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MergeEnvironment.Production,

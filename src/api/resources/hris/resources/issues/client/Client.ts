...
export class IssuesClient {
    ...
    ): Promise<core.Page<Merge.hris.Issue, Merge.hris.PaginatedIssueList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const _queryParams: Record<string, unknown> = {
                    ...
                    status:
                        status != null
                            ? serializers.hris.IssuesListRequestStatus.jsonOrThrow(status, {
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/hris/v1/issues");
            },
        );
        const dataWithRawResponse = await list(request).withRawResponse();
        return new core.Page<Merge.hris.Issue, Merge.hris.PaginatedIssueList>({
    ...
    private async __retrieve(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/hris/v1/issues/{id}");
    }
}

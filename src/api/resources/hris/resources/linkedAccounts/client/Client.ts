...
export class LinkedAccountsClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.hris.AccountDetailsAndActions, Merge.hris.PaginatedAccountDetailsAndActionsList>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const _queryParams: Record<string, unknown> = {
                    category:
                        category != null
                            ? serializers.hris.LinkedAccountsListRequestCategory.jsonOrThrow(category, {
        ...
        return new core.Page<Merge.hris.AccountDetailsAndActions, Merge.hris.PaginatedAccountDetailsAndActionsList>({

...
export class EmployerBenefitsClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<EmployerBenefitsClient.Options>;
    ...
    public async list(
    ...
    ): Promise<core.Page<Merge.hris.EmployerBenefit, Merge.hris.PaginatedEmployerBenefitList>> {
        ...
        return new core.Page<Merge.hris.EmployerBenefit, Merge.hris.PaginatedEmployerBenefitList>({

...
export class LinkToken {
    ...
    public async create(
        ...
        const _response = await core.fetcher({
            ...
            body: await serializers.hris.EndUserDetailsRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return await serializers.hris.LinkToken.parseOrThrow(_response.body, {

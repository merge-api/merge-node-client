...
export class AvailableActions {
     ...
     */
    public async retrieve(requestOptions?: AvailableActions.RequestOptions): Promise<Merge.hris.AvailableActions> {
        ...
        if (_response.ok) {
            return serializers.hris.AvailableActions.parseOrThrow(_response.body, {

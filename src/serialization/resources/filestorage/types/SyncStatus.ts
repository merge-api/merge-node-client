...
> = core.serialization.object({
    ...
    status: core.serialization.lazy(async () => (await import("../../..")).filestorage.SyncStatusStatusEnum),
    ...
    selectiveSyncConfigurationsUsage: core.serialization.property(
        ...
        core.serialization
            .lazy(async () => (await import("../../..")).filestorage.SelectiveSyncConfigurationsUsageEnum)
            .optional()
    ),
});
...
export declare namespace SyncStatus {
    interface Raw {
        ...
        status: serializers.filestorage.SyncStatusStatusEnum.Raw;
        is_initial_sync: boolean;
        selective_sync_configurations_usage?: serializers.filestorage.SelectiveSyncConfigurationsUsageEnum.Raw | null;
    }
}

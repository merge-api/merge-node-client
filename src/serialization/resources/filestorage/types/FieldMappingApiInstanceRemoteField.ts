...
> = core.serialization.object({
    ...
    remoteEndpointInfo: core.serialization.property(
        ...
        core.serialization.lazyObject(
            async () => (await import("../../..")).filestorage.FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo
        )
    ),
});
...
export declare namespace FieldMappingApiInstanceRemoteField {
    interface Raw {
        ...
        remote_endpoint_info: serializers.filestorage.FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo.Raw;
    }
}

...
export const MultipartFormFieldRequest: core.serialization.ObjectSchema<
    serializers.filestorage.MultipartFormFieldRequest.Raw,
    Merge.filestorage.MultipartFormFieldRequest
> = core.serialization.object({
    name: core.serialization.string(),
    data: core.serialization.string(),
    encoding: core.serialization
        .lazy(async () => (await import("../../..")).filestorage.MultipartFormFieldRequestEncoding)
        .optional(),
...
export declare namespace MultipartFormFieldRequest {
    interface Raw {
        name: string;
        data: string;
        encoding?: serializers.filestorage.MultipartFormFieldRequestEncoding.Raw | null;

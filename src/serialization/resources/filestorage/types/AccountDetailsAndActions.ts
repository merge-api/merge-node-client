...
> = core.serialization.object({
    ...
    category: core.serialization.lazy(async () => (await import("../../..")).filestorage.CategoryEnum).optional(),
    status: core.serialization.lazy(
        async () => (await import("../../..")).filestorage.AccountDetailsAndActionsStatusEnum
    ),
...
export declare namespace AccountDetailsAndActions {
    interface Raw {
        id: string;
        category?: serializers.filestorage.CategoryEnum.Raw | null;
        status: serializers.filestorage.AccountDetailsAndActionsStatusEnum.Raw;

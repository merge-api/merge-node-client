...
export const ConditionSchema: core.serialization.ObjectSchema<
    serializers.filestorage.ConditionSchema.Raw,
    Merge.filestorage.ConditionSchema
> = core.serialization.object({
    ...
    conditionType: core.serialization.property(
        "condition_type",
        core.serialization.lazy(async () => (await import("../../..")).filestorage.ConditionSchemaConditionType)
    ),
    operators: core.serialization.list(
        core.serialization.lazyObject(async () => (await import("../../..")).filestorage.OperatorSchema)
    ),
});
...
export declare namespace ConditionSchema {
    interface Raw {
        ...
        condition_type: serializers.filestorage.ConditionSchemaConditionType.Raw;
        operators: serializers.filestorage.OperatorSchema.Raw[];
    }
}

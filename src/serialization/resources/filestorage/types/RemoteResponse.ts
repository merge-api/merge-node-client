...
export const RemoteResponse: core.serialization.ObjectSchema<
    ...
    Merge.filestorage.RemoteResponse
> = core.serialization.object({
    ...
    responseType: core.serialization.property(
        "response_type",
        core.serialization.lazy(async () => (await import("../../..")).filestorage.ResponseTypeEnum).optional()
    ),
...
export declare namespace RemoteResponse {
    interface Raw {
        ...
        response_type?: serializers.filestorage.ResponseTypeEnum.Raw | null;

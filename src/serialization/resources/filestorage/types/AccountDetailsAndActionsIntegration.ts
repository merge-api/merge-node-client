...
export const AccountDetailsAndActionsIntegration: core.serialization.ObjectSchema<
    serializers.filestorage.AccountDetailsAndActionsIntegration.Raw,
    Merge.filestorage.AccountDetailsAndActionsIntegration
> = core.serialization.object({
    ...
    availableModelOperations: core.serialization.property(
        ...
        core.serialization
            .list(core.serialization.lazyObject(async () => (await import("../../..")).filestorage.ModelOperation))
            .optional()
    ),
});
...
export declare namespace AccountDetailsAndActionsIntegration {
    interface Raw {
        ...
        available_model_operations?: serializers.filestorage.ModelOperation.Raw[] | null;
    }
}

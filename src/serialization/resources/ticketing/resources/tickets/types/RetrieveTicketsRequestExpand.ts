...
export const RetrieveTicketsRequestExpand: core.serialization.Schema<
    serializers.ticketing.RetrieveTicketsRequestExpand.Raw,
    Merge.ticketing.RetrieveTicketsRequestExpand
...
export declare namespace RetrieveTicketsRequestExpand {
    export type Raw =
        | "account"
        | "account,contact"
        | "account,contact,creator"

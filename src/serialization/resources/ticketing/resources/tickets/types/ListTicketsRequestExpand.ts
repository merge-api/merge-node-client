...
export const ListTicketsRequestExpand: core.serialization.Schema<
    serializers.ticketing.ListTicketsRequestExpand.Raw,
    Merge.ticketing.ListTicketsRequestExpand
...
export declare namespace ListTicketsRequestExpand {
    export type Raw =
        | "account"
        | "account,contact"
        | "account,contact,creator"

...
export const CommonModelScopesBodyRequest: core.serialization.ObjectSchema<
    serializers.ticketing.CommonModelScopesBodyRequest.Raw,
...
> = core.serialization.object({
    ...
    enabledActions: core.serialization.property(
        ...
        core.serialization.list(
            core.serialization.lazy(async () => (await import("../../..")).ticketing.EnabledActionsEnum)
        )
    ),
...
export declare namespace CommonModelScopesBodyRequest {
    interface Raw {
        model_id: string;
        enabled_actions: serializers.ticketing.EnabledActionsEnum.Raw[];

...
> = core.serialization.object({
    ...
    eventType: core.serialization.property(
        "event_type",
        core.serialization.lazy(async () => (await import("../../..")).ticketing.AuditLogEventEventType)
    ),
...
export declare namespace AuditLogEvent {
    interface Raw {
        ...
        role: serializers.ticketing.AuditLogEventRole.Raw;
        ip_address: string;
        event_type: serializers.ticketing.AuditLogEventEventType.Raw;

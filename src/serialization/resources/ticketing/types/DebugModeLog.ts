...
export const DebugModeLog: core.serialization.ObjectSchema<
    serializers.ticketing.DebugModeLog.Raw,
    Merge.ticketing.DebugModeLog
> = core.serialization.object({
    ...
    logSummary: core.serialization.property(
        "log_summary",
        core.serialization.lazyObject(async () => (await import("../../..")).ticketing.DebugModelLogSummary)
    ),
});
...
export declare namespace DebugModeLog {
    interface Raw {
        ...
        log_summary: serializers.ticketing.DebugModelLogSummary.Raw;
    }
}

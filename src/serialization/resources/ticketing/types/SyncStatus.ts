...
export const SyncStatus: core.serialization.ObjectSchema<
    serializers.ticketing.SyncStatus.Raw,
...
> = core.serialization.object({
    ...
    status: core.serialization.lazy(async () => (await import("../../..")).ticketing.SyncStatusStatusEnum),
    ...
    selectiveSyncConfigurationsUsage: core.serialization.property(
        ...
        core.serialization
            .lazy(async () => (await import("../../..")).ticketing.SelectiveSyncConfigurationsUsageEnum)
            .optional()
    ),
});
...
export declare namespace SyncStatus {
    interface Raw {
        ...
        status: serializers.ticketing.SyncStatusStatusEnum.Raw;
        is_initial_sync: boolean;
        selective_sync_configurations_usage?: serializers.ticketing.SelectiveSyncConfigurationsUsageEnum.Raw | null;
    }
}

...
> = core.serialization.object({
    ...
    remoteEndpointInfo: core.serialization.property(
        ...
        core.serialization.lazyObject(
            async () => (await import("../../..")).ticketing.FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo
        )
    ),
});
...
export declare namespace FieldMappingApiInstanceRemoteField {
    interface Raw {
        ...
        remote_endpoint_info: serializers.ticketing.FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo.Raw;
    }
}

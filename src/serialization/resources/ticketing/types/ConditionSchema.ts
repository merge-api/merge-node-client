...
export const ConditionSchema: core.serialization.ObjectSchema<
    serializers.ticketing.ConditionSchema.Raw,
    Merge.ticketing.ConditionSchema
> = core.serialization.object({
    ...
    conditionType: core.serialization.property(
        "condition_type",
        core.serialization.lazy(async () => (await import("../../..")).ticketing.ConditionSchemaConditionType)
    ),
    operators: core.serialization.list(
        core.serialization.lazyObject(async () => (await import("../../..")).ticketing.OperatorSchema)
    ),
});
...
export declare namespace ConditionSchema {
    interface Raw {
        ...
        condition_type: serializers.ticketing.ConditionSchemaConditionType.Raw;
        operators: serializers.ticketing.OperatorSchema.Raw[];
    }
}

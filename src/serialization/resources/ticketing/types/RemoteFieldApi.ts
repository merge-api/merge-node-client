...
> = core.serialization.object({
    ...
    advancedMetadata: core.serialization.property("advanced_metadata", AdvancedMetadata.nullable()),
    coverage: RemoteFieldApiCoverage.optionalNullable(),
});
...
export declare namespace RemoteFieldApi {
    export interface Raw {
        ...
        example_values?: (unknown[] | null) | null;
        advanced_metadata: AdvancedMetadata.Raw | null;
        coverage?: (RemoteFieldApiCoverage.Raw | null) | null;
    }
}

...
export const RemoteFieldApi: core.serialization.ObjectSchema<
    serializers.ticketing.RemoteFieldApi.Raw,
    Merge.ticketing.RemoteFieldApi
> = core.serialization.object({
    ...
    remoteEndpointInfo: core.serialization.property(
        ...
        core.serialization.lazyObject(async () => (await import("../../..")).ticketing.RemoteEndpointInfo)
    ),
    ...
    advancedMetadata: core.serialization.property(
        "advanced_metadata",
        core.serialization.lazyObject(async () => (await import("../../..")).ticketing.AdvancedMetadata).optional()
    ),
    coverage: core.serialization
        .lazy(async () => (await import("../../..")).ticketing.RemoteFieldApiCoverage)
        .optional(),
});
...
export declare namespace RemoteFieldApi {
    interface Raw {
        ...
        remote_endpoint_info: serializers.ticketing.RemoteEndpointInfo.Raw;
        example_values?: unknown[] | null;
        advanced_metadata?: serializers.ticketing.AdvancedMetadata.Raw | null;
        coverage?: serializers.ticketing.RemoteFieldApiCoverage.Raw | null;
    }
}

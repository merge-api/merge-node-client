...
> = core.serialization.object({
    ...
    remoteEndpointInfo: core.serialization.property(
        ...
        core.serialization.lazyObject(
            async () => (await import("../../..")).crm.FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo
        )
    ),
});
...
export declare namespace FieldMappingApiInstanceRemoteField {
    interface Raw {
        ...
        remote_endpoint_info: serializers.crm.FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo.Raw;
    }
}

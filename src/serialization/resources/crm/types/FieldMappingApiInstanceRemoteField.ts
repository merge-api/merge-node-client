...
export const FieldMappingApiInstanceRemoteField: core.serialization.ObjectSchema<
    serializers.crm.FieldMappingApiInstanceRemoteField.Raw,
    Merge.crm.FieldMappingApiInstanceRemoteField
> = core.serialization.object({
    remoteKeyName: core.serialization.property("remote_key_name", core.serialization.string().nullable()),
    schema: core.serialization.record(core.serialization.string(), core.serialization.unknown()).nullable(),

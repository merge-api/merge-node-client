...
> = core.serialization.object({
    ...
    role: core.serialization.lazy(async () => (await import("../../..")).crm.AuditLogEventRole),
    ipAddress: core.serialization.property("ip_address", core.serialization.string()),
    eventType: core.serialization.property(
        "event_type",
        core.serialization.lazy(async () => (await import("../../..")).crm.AuditLogEventEventType)
    ),
...
export declare namespace AuditLogEvent {
    interface Raw {
        ...
        role: serializers.crm.AuditLogEventRole.Raw;
        ip_address: string;
        event_type: serializers.crm.AuditLogEventEventType.Raw;

...
> = core.serialization.object({
    method: core.serialization.lazy(async () => (await import("../../..")).crm.MethodEnum),
    ...
    multipartFormData: core.serialization.property(
        "multipart_form_data",
        core.serialization
            .list(core.serialization.lazyObject(async () => (await import("../../..")).crm.MultipartFormFieldRequest))
            .optional()
    ),
    ...
    requestFormat: core.serialization.property(
        "request_format",
        core.serialization.lazy(async () => (await import("../../..")).crm.RequestFormatEnum).optional()
    ),
...
export declare namespace DataPassthroughRequest {
    interface Raw {
        method: serializers.crm.MethodEnum.Raw;
        path: string;
        base_url_override?: string | null;
        data?: string | null;
        multipart_form_data?: serializers.crm.MultipartFormFieldRequest.Raw[] | null;
        headers?: Record<string, unknown> | null;
        request_format?: serializers.crm.RequestFormatEnum.Raw | null;

...
export const RemoteResponse: core.serialization.ObjectSchema<
    serializers.crm.RemoteResponse.Raw,
    Merge.crm.RemoteResponse
> = core.serialization.object({
    ...
    responseType: core.serialization.property(
        "response_type",
        core.serialization.lazy(async () => (await import("../../..")).crm.ResponseTypeEnum).optional()
    ),
...
export declare namespace RemoteResponse {
    interface Raw {
        ...
        response_type?: serializers.crm.ResponseTypeEnum.Raw | null;

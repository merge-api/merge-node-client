...
export const ListEngagementsRequestExpand: core.serialization.Schema<
    serializers.crm.ListEngagementsRequestExpand.Raw,
    Merge.crm.ListEngagementsRequestExpand
...
export declare namespace ListEngagementsRequestExpand {
    export type Raw =
        | "account"
        | "account,engagement_type"
        | "contacts"

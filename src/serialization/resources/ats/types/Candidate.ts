...
export const Candidate: core.serialization.ObjectSchema<serializers.ats.Candidate.Raw, Merge.ats.Candidate> =
    core.serialization.object({
        ...
        phoneNumbers: core.serialization.property(
            "phone_numbers",
            core.serialization
                .list(core.serialization.lazyObject(async () => (await import("../../..")).ats.PhoneNumber))
                .optional()
        ),
        emailAddresses: core.serialization.property(
            "email_addresses",
            core.serialization
                .list(core.serialization.lazyObject(async () => (await import("../../..")).ats.EmailAddress))
                .optional()
        ),
...
export declare namespace Candidate {
    interface Raw {
        ...
        phone_numbers?: serializers.ats.PhoneNumber.Raw[] | null;

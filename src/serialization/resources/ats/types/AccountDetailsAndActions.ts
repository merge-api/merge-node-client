...
export const AccountDetailsAndActions: core.serialization.ObjectSchema<
    serializers.ats.AccountDetailsAndActions.Raw,
    Merge.ats.AccountDetailsAndActions
> = core.serialization.object({
    id: core.serialization.string(),
    category: core.serialization.lazy(async () => (await import("../../..")).ats.CategoryEnum).optional(),
    status: core.serialization.lazy(async () => (await import("../../..")).ats.AccountDetailsAndActionsStatusEnum),
    ...
    integration: core.serialization
        .lazyObject(async () => (await import("../../..")).ats.AccountDetailsAndActionsIntegration)
        .optional(),
});
...
export declare namespace AccountDetailsAndActions {
    interface Raw {
        id: string;
        category?: serializers.ats.CategoryEnum.Raw | null;
        status: serializers.ats.AccountDetailsAndActionsStatusEnum.Raw;
        ...
        integration?: serializers.ats.AccountDetailsAndActionsIntegration.Raw | null;
    }
}

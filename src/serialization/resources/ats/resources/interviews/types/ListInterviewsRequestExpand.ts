...
export const ListInterviewsRequestExpand: core.serialization.Schema<
    serializers.ats.ListInterviewsRequestExpand.Raw,
    Merge.ats.ListInterviewsRequestExpand
...
export declare namespace ListInterviewsRequestExpand {
    export type Raw =
        | "application"
        | "application,job_interview_stage"
        | "interviewers"

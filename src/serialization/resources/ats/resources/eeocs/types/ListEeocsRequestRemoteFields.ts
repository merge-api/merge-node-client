...
export const ListEeocsRequestRemoteFields: core.serialization.Schema<
    serializers.ats.ListEeocsRequestRemoteFields.Raw,
    Merge.ats.ListEeocsRequestRemoteFields
...
export declare namespace ListEeocsRequestRemoteFields {
    export type Raw =
        | "disability_status"
        | "disability_status,gender"
        | "disability_status,gender,race"

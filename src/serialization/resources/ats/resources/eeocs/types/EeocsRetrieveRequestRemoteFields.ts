...
export const EeocsRetrieveRequestRemoteFields: core.serialization.Schema<
    serializers.ats.EeocsRetrieveRequestRemoteFields.Raw,
...
export declare namespace EeocsRetrieveRequestRemoteFields {
    type Raw =
        | "disability_status"
        | "disability_status,gender"
        | "disability_status,gender,race"

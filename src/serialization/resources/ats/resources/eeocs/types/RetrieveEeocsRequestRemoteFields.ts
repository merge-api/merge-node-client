...
export const RetrieveEeocsRequestRemoteFields: core.serialization.Schema<
    serializers.ats.RetrieveEeocsRequestRemoteFields.Raw,
...
export declare namespace RetrieveEeocsRequestRemoteFields {
    export type Raw =
        | "disability_status"
        | "disability_status,gender"
        | "disability_status,gender,race"

...
export const RetrieveEeocsRequestShowEnumOrigins: core.serialization.Schema<
    serializers.ats.RetrieveEeocsRequestShowEnumOrigins.Raw,
    Merge.ats.RetrieveEeocsRequestShowEnumOrigins
...
export declare namespace RetrieveEeocsRequestShowEnumOrigins {
    export type Raw =
        | "disability_status"
        | "disability_status,gender"
        | "disability_status,gender,race"

...
export const ListJobsRequestExpand: core.serialization.Schema<
    serializers.ats.ListJobsRequestExpand.Raw,
    Merge.ats.ListJobsRequestExpand
...
export declare namespace ListJobsRequestExpand {
    export type Raw =
        | "departments"
        | "departments,hiring_managers"
        | "departments,hiring_managers,job_postings"

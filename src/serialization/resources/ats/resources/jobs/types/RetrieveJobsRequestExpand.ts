...
export const RetrieveJobsRequestExpand: core.serialization.Schema<
    serializers.ats.RetrieveJobsRequestExpand.Raw,
    Merge.ats.RetrieveJobsRequestExpand
...
export declare namespace RetrieveJobsRequestExpand {
    export type Raw =
        | "departments"
        | "departments,hiring_managers"
        | "departments,hiring_managers,job_postings"

...
export const EmployeesListRequestExpand: core.serialization.Schema<
    serializers.hris.EmployeesListRequestExpand.Raw,
    Merge.hris.EmployeesListRequestExpand
...
export declare namespace EmployeesListRequestExpand {
    type Raw =
        | "company"
        | "company,pay_group"
        | "employments"

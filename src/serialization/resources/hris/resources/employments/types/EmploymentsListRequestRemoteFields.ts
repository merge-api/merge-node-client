...
export const EmploymentsListRequestRemoteFields: core.serialization.Schema<
    serializers.hris.EmploymentsListRequestRemoteFields.Raw,
    Merge.hris.EmploymentsListRequestRemoteFields
...
export declare namespace EmploymentsListRequestRemoteFields {
    type Raw =
        | "employment_type"
        | "employment_type,flsa_status"
        | "employment_type,flsa_status,pay_frequency"

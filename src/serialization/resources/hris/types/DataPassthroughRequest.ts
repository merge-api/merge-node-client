...
> = core.serialization.object({
    method: core.serialization.lazy(async () => (await import("../../..")).hris.MethodEnum),
    ...
    multipartFormData: core.serialization.property(
        "multipart_form_data",
        core.serialization
            .list(core.serialization.lazyObject(async () => (await import("../../..")).hris.MultipartFormFieldRequest))
            .optional()
    ),
    ...
    requestFormat: core.serialization.property(
        "request_format",
        core.serialization.lazy(async () => (await import("../../..")).hris.RequestFormatEnum).optional()
    ),
...
export declare namespace DataPassthroughRequest {
    interface Raw {
        method: serializers.hris.MethodEnum.Raw;
        path: string;
        base_url_override?: string | null;
        data?: string | null;
        multipart_form_data?: serializers.hris.MultipartFormFieldRequest.Raw[] | null;
        headers?: Record<string, unknown> | null;
        request_format?: serializers.hris.RequestFormatEnum.Raw | null;

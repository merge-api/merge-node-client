...
export const AccountDetailsAndActionsIntegration: core.serialization.ObjectSchema<
    serializers.hris.AccountDetailsAndActionsIntegration.Raw,
    Merge.hris.AccountDetailsAndActionsIntegration
> = core.serialization.object({
    name: core.serialization.string(),
    categories: core.serialization.list(
        core.serialization.lazy(async () => (await import("../../..")).hris.CategoriesEnum)
    ),
...
export declare namespace AccountDetailsAndActionsIntegration {
    interface Raw {
        name: string;
        categories: serializers.hris.CategoriesEnum.Raw[];
        image?: string | null;

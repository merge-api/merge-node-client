...
export const MultipartFormFieldRequest: core.serialization.ObjectSchema<
    serializers.hris.MultipartFormFieldRequest.Raw,
    Merge.hris.MultipartFormFieldRequest
> = core.serialization.object({
    name: core.serialization.string(),
    data: core.serialization.string(),
    encoding: core.serialization
        .lazy(async () => (await import("../../..")).hris.MultipartFormFieldRequestEncoding)
        .optional(),
...
export declare namespace MultipartFormFieldRequest {
    interface Raw {
        name: string;
        data: string;
        encoding?: serializers.hris.MultipartFormFieldRequestEncoding.Raw | null;

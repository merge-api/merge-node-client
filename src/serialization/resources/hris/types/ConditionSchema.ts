...
export const ConditionSchema: core.serialization.ObjectSchema<
    serializers.hris.ConditionSchema.Raw,
    Merge.hris.ConditionSchema
> = core.serialization.object({
    ...
    conditionType: core.serialization.property(
        "condition_type",
        core.serialization.lazy(async () => (await import("../../..")).hris.ConditionSchemaConditionType)
    ),
    operators: core.serialization.list(
        core.serialization.lazyObject(async () => (await import("../../..")).hris.OperatorSchema)
    ),
});
...
export declare namespace ConditionSchema {
    interface Raw {
        ...
        condition_type: serializers.hris.ConditionSchemaConditionType.Raw;
        operators: serializers.hris.OperatorSchema.Raw[];
    }
}

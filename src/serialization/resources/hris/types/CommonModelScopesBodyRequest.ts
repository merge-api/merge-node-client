...
export const CommonModelScopesBodyRequest: core.serialization.ObjectSchema<
    serializers.hris.CommonModelScopesBodyRequest.Raw,
    Merge.hris.CommonModelScopesBodyRequest
> = core.serialization.object({
    modelId: core.serialization.property("model_id", core.serialization.string()),
    enabledActions: core.serialization.property(
        "enabled_actions",
        core.serialization.list(core.serialization.lazy(async () => (await import("../../..")).hris.EnabledActionsEnum))
    ),
...
export declare namespace CommonModelScopesBodyRequest {
    interface Raw {
        model_id: string;
        enabled_actions: serializers.hris.EnabledActionsEnum.Raw[];

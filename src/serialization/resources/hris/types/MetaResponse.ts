...
export const MetaResponse: core.serialization.ObjectSchema<serializers.hris.MetaResponse.Raw, Merge.hris.MetaResponse> =
    core.serialization.object({
        ...
        status: core.serialization
            .lazyObject(async () => (await import("../../..")).hris.LinkedAccountStatus)
            .optional(),
...
export declare namespace MetaResponse {
    interface Raw {
        ...
        status?: serializers.hris.LinkedAccountStatus.Raw | null;

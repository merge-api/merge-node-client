...
export const ConditionSchema: core.serialization.ObjectSchema<
    serializers.accounting.ConditionSchema.Raw,
    Merge.accounting.ConditionSchema
> = core.serialization.object({
    ...
    conditionType: core.serialization.property(
        "condition_type",
        core.serialization.lazy(async () => (await import("../../..")).accounting.ConditionSchemaConditionType)
    ),
    operators: core.serialization.list(
        core.serialization.lazyObject(async () => (await import("../../..")).accounting.OperatorSchema)
    ),
});
...
export declare namespace ConditionSchema {
    interface Raw {
        ...
        condition_type: serializers.accounting.ConditionSchemaConditionType.Raw;
        operators: serializers.accounting.OperatorSchema.Raw[];
    }
}

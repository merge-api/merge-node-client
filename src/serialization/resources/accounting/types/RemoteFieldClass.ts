...
> = core.serialization.object({
    ...
    fieldType: core.serialization.property(
        "field_type",
        core.serialization.lazy(async () => (await import("../../..")).accounting.FieldTypeEnum).optional()
    ),
    fieldFormat: core.serialization.property(
        "field_format",
        core.serialization.lazy(async () => (await import("../../..")).accounting.FieldFormatEnum).optional()
    ),
    ...
    itemSchema: core.serialization.property(
        "item_schema",
        core.serialization.lazyObject(async () => (await import("../../..")).accounting.ItemSchema).optional()
    ),
});
...
export declare namespace RemoteFieldClass {
    interface Raw {
        ...
        field_type?: serializers.accounting.FieldTypeEnum.Raw | null;
        field_format?: serializers.accounting.FieldFormatEnum.Raw | null;
        field_choices?: string[] | null;
        item_schema?: serializers.accounting.ItemSchema.Raw | null;
    }
}

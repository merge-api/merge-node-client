...
export const ExpenseReportRequestCurrency: core.serialization.Schema<
    serializers.accounting.ExpenseReportRequestCurrency.Raw,
    Merge.accounting.ExpenseReportRequestCurrency
> = core.serialization.undiscriminatedUnion([TransactionCurrencyEnum, core.serialization.string()]);

export declare namespace ExpenseReportRequestCurrency {

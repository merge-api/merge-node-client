...
export const MetaResponse: core.serialization.ObjectSchema<
    serializers.accounting.MetaResponse.Raw,
    Merge.accounting.MetaResponse
> = core.serialization.object({
    ...
    status: core.serialization
        .lazyObject(async () => (await import("../../..")).accounting.LinkedAccountStatus)
        .optional(),
...
export declare namespace MetaResponse {
    interface Raw {
        ...
        status?: serializers.accounting.LinkedAccountStatus.Raw | null;

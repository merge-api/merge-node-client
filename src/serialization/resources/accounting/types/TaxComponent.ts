...
> = core.serialization.object({
    ...
    componentType: core.serialization.property(
        "component_type",
        core.serialization.lazy(async () => (await import("../../..")).accounting.TaxComponentComponentType).optional()
    ),
...
export declare namespace TaxComponent {
    interface Raw {
        ...
        component_type?: serializers.accounting.TaxComponentComponentType.Raw | null;

...
> = core.serialization.object({
    ...
    relatedObjectType: core.serialization.property(
        "related_object_type",
        core.serialization
            .lazy(async () => (await import("../../..")).accounting.PaymentLineItemRequestRelatedObjectType)
            .optional()
    ),
...
export declare namespace PaymentLineItemRequest {
    interface Raw {
        ...
        related_object_type?: serializers.accounting.PaymentLineItemRequestRelatedObjectType.Raw | null;

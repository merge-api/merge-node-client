...
> = core.serialization.object({
    ...
    role: core.serialization.lazy(async () => (await import("../../..")).accounting.AuditLogEventRole),
    ipAddress: core.serialization.property("ip_address", core.serialization.string()),
    eventType: core.serialization.property(
        "event_type",
        core.serialization.lazy(async () => (await import("../../..")).accounting.AuditLogEventEventType)
    ),
...
export declare namespace AuditLogEvent {
    interface Raw {
        ...
        role: serializers.accounting.AuditLogEventRole.Raw;
        ip_address: string;
        event_type: serializers.accounting.AuditLogEventEventType.Raw;

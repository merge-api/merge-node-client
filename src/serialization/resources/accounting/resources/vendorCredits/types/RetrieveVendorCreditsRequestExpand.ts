...
export const RetrieveVendorCreditsRequestExpand: core.serialization.Schema<
    serializers.accounting.RetrieveVendorCreditsRequestExpand.Raw,
    Merge.accounting.RetrieveVendorCreditsRequestExpand
...
export declare namespace RetrieveVendorCreditsRequestExpand {
    export type Raw =
        | "accounting_period"
        | "company"
        | "company,accounting_period"

...
export const RetrievePaymentsRequestExpand: core.serialization.Schema<
    serializers.accounting.RetrievePaymentsRequestExpand.Raw,
    Merge.accounting.RetrievePaymentsRequestExpand
...
export declare namespace RetrievePaymentsRequestExpand {
    export type Raw =
        | "account"
        | "account,accounting_period"
        | "account,accounting_period,payment_method"

...
export const ListCreditNotesRequestExpand: core.serialization.Schema<
    serializers.accounting.ListCreditNotesRequestExpand.Raw,
    Merge.accounting.ListCreditNotesRequestExpand
...
export declare namespace ListCreditNotesRequestExpand {
    export type Raw =
        | "accounting_period"
        | "applied_payments"
        | "applied_payments,accounting_period"

...
export const RetrievePurchaseOrdersRequestExpand: core.serialization.Schema<
    serializers.accounting.RetrievePurchaseOrdersRequestExpand.Raw,
    Merge.accounting.RetrievePurchaseOrdersRequestExpand
...
export declare namespace RetrievePurchaseOrdersRequestExpand {
    export type Raw =
        | "accounting_period"
        | "accounting_period,payment_term"
        | "company"

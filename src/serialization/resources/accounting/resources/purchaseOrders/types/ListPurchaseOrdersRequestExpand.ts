...
export const ListPurchaseOrdersRequestExpand: core.serialization.Schema<
    serializers.accounting.ListPurchaseOrdersRequestExpand.Raw,
    Merge.accounting.ListPurchaseOrdersRequestExpand
...
export declare namespace ListPurchaseOrdersRequestExpand {
    export type Raw =
        | "accounting_period"
        | "accounting_period,payment_term"
        | "company"

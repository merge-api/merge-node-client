...
export const RetrieveExpensesRequestExpand: core.serialization.Schema<
    serializers.accounting.RetrieveExpensesRequestExpand.Raw,
    Merge.accounting.RetrieveExpensesRequestExpand
...
export declare namespace RetrieveExpensesRequestExpand {
    export type Raw =
        | "account"
        | "account,accounting_period"
        | "account,company"

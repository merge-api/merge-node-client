...
export const ListExpensesRequestExpand: core.serialization.Schema<
    serializers.accounting.ListExpensesRequestExpand.Raw,
    Merge.accounting.ListExpensesRequestExpand
...
export declare namespace ListExpensesRequestExpand {
    export type Raw =
        | "account"
        | "account,accounting_period"
        | "account,company"

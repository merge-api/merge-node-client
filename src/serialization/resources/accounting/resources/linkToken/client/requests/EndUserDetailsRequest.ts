...
> = core.serialization.object({
    ...
    categories: core.serialization.list(
        core.serialization.lazy(async () => (await import("../../../../../..")).accounting.CategoriesEnum)
    ),
        ...
        core.serialization
            .list(
                core.serialization.lazyObject(
                    async () => (await import("../../../../../..")).accounting.CommonModelScopesBodyRequest
                )
            )
            .optional()
    ),
...
export declare namespace EndUserDetailsRequest {
    interface Raw {
        ...
        categories: serializers.accounting.CategoriesEnum.Raw[];

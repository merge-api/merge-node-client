...
export const LinesListExpenseReportsRequestExpand: core.serialization.Schema<
    serializers.accounting.LinesListExpenseReportsRequestExpand.Raw,
    Merge.accounting.LinesListExpenseReportsRequestExpand
...
export declare namespace LinesListExpenseReportsRequestExpand {
    export type Raw =
        | "account"
        | "account,company"
        | "account,company,contact"

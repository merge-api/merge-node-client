...
export const ListTransactionsRequestExpand: core.serialization.Schema<
    serializers.accounting.ListTransactionsRequestExpand.Raw,
    Merge.accounting.ListTransactionsRequestExpand
...
export declare namespace ListTransactionsRequestExpand {
    export type Raw =
        | "account"
        | "account,accounting_period"
        | "account,company"

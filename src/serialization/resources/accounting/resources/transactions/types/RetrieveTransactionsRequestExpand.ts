...
export const RetrieveTransactionsRequestExpand: core.serialization.Schema<
    serializers.accounting.RetrieveTransactionsRequestExpand.Raw,
    Merge.accounting.RetrieveTransactionsRequestExpand
...
export declare namespace RetrieveTransactionsRequestExpand {
    export type Raw =
        | "account"
        | "account,accounting_period"
        | "account,company"

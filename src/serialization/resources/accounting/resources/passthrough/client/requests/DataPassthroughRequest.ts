...
> = core.serialization.object({
    method: core.serialization.lazy(async () => (await import("../../../../../..")).accounting.MethodEnum),
        ...
        core.serialization
            .list(
                core.serialization.lazyObject(
                    async () => (await import("../../../../../..")).accounting.MultipartFormFieldRequest
                )
            )
            .optional()
    ),
    ...
    requestFormat: core.serialization.property(
        "request_format",
        core.serialization.lazy(async () => (await import("../../../../../..")).accounting.RequestFormatEnum).optional()
    ),
...
export declare namespace DataPassthroughRequest {
    interface Raw {
        method: serializers.accounting.MethodEnum.Raw;
        path: string;
        base_url_override?: string | null;
        data?: string | null;
        multipart_form_data?: serializers.accounting.MultipartFormFieldRequest.Raw[] | null;
        headers?: Record<string, unknown> | null;
        request_format?: serializers.accounting.RequestFormatEnum.Raw | null;

...
export const GeneralLedgerTransactionsRetrieveRequestExpand: core.serialization.Schema<
    serializers.accounting.GeneralLedgerTransactionsRetrieveRequestExpand.Raw,
    Merge.accounting.GeneralLedgerTransactionsRetrieveRequestExpand

...
export const RetrieveGeneralLedgerTransactionsRequestExpand: core.serialization.Schema<
    serializers.accounting.RetrieveGeneralLedgerTransactionsRequestExpand.Raw,
    Merge.accounting.RetrieveGeneralLedgerTransactionsRequestExpand
...
export declare namespace RetrieveGeneralLedgerTransactionsRequestExpand {
    export type Raw =
        | "accounting_period"
        | "company"
        | "company,accounting_period"

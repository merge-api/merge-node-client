...
export const RetrieveItemsRequestExpand: core.serialization.Schema<
    serializers.accounting.RetrieveItemsRequestExpand.Raw,
    Merge.accounting.RetrieveItemsRequestExpand
...
export declare namespace RetrieveItemsRequestExpand {
    export type Raw =
        | "company"
        | "company,purchase_tax_rate"
        | "company,sales_tax_rate"

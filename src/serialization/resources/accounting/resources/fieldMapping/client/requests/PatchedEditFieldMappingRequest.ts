...
export const PatchedEditFieldMappingRequest: core.serialization.Schema<
    serializers.accounting.PatchedEditFieldMappingRequest.Raw,
    Omit<Merge.accounting.PatchedEditFieldMappingRequest, "remoteDataIterationCount">
> = core.serialization.object({
    ...
    advancedMappingExpression: core.serialization.property(
...
export declare namespace PatchedEditFieldMappingRequest {
    export interface Raw {
        ...
        advanced_mapping_expression?: string | null;
    }
}

...
export const ListJournalEntriesRequestExpand: core.serialization.Schema<
    serializers.accounting.ListJournalEntriesRequestExpand.Raw,
    Merge.accounting.ListJournalEntriesRequestExpand
...
export declare namespace ListJournalEntriesRequestExpand {
    export type Raw =
        | "accounting_period"
        | "applied_payments"
        | "applied_payments,accounting_period"

...
export const RetrieveJournalEntriesRequestExpand: core.serialization.Schema<
    serializers.accounting.RetrieveJournalEntriesRequestExpand.Raw,
    Merge.accounting.RetrieveJournalEntriesRequestExpand
...
export declare namespace RetrieveJournalEntriesRequestExpand {
    export type Raw =
        | "accounting_period"
        | "applied_payments"
        | "applied_payments,accounting_period"

...
export const FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo: core.serialization.ObjectSchema<
    serializers.knowledgebase.FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo.Raw,
    Merge.knowledgebase.FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo

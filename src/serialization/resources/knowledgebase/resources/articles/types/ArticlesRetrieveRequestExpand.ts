...
export const ArticlesRetrieveRequestExpand: core.serialization.Schema<
    serializers.knowledgebase.ArticlesRetrieveRequestExpand.Raw,
    Merge.knowledgebase.ArticlesRetrieveRequestExpand
...
export declare namespace ArticlesRetrieveRequestExpand {
    export type Raw =
        | "attachments"
        | "attachments,author"
        | "attachments,author,last_edited_by"

...
describe("Groups", () => {
    test("list", async () => {
            ...
            results: [
                {
                    ...
                    users: ["6e93361b-8ae7-444b-bfa2-71206cbbee24", "a1f90b3c-633d-404e-a696-05cd54808676"],
        ...
        server
            .mockEndpoint()
            .get("/knowledgebase/v1/groups")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.knowledgebase.groups.list({
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/knowledgebase/v1/groups/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.knowledgebase.groups.retrieve("id");
        expect(response).toEqual({
            id: "134e0111-0f67-44f6-98f0-597000290bb3",
            remoteId: "800293",
            createdAt: new Date("2021-09-15T00:00:00.000Z"),

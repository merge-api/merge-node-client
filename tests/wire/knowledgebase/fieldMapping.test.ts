...
describe("FieldMappingClient", () => {
    test("field_mappings_retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/knowledgebase/v1/field-mappings")
            .respondWith()
            .statusCode(200)
    ...
    test("field_mappings_create", async () => {
        ...
        server
            .mockEndpoint()
            .post("/knowledgebase/v1/field-mappings")
    ...
    test("field_mappings_destroy", async () => {
        ...
        server
            .mockEndpoint()
            .delete("/knowledgebase/v1/field-mappings/field_mapping_id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.knowledgebase.fieldMapping.fieldMappingsDestroy("field_mapping_id");
        expect(response).toEqual({
            model: {
                id: "3fa85f64-5717-4562-b3fc-2c963f66afa6",
                isIntegrationWide: true,
    ...
    test("field_mappings_partial_update", async () => {
        ...
        server
            .mockEndpoint()
            .patch("/knowledgebase/v1/field-mappings/field_mapping_id")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
        ...
        const response = await client.knowledgebase.fieldMapping.fieldMappingsPartialUpdate("field_mapping_id");
        expect(response).toEqual({
            model: {
                id: "3fa85f64-5717-4562-b3fc-2c963f66afa6",
                isIntegrationWide: true,
    ...
    test("remote_fields_retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/knowledgebase/v1/remote-fields")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.knowledgebase.fieldMapping.remoteFieldsRetrieve({
    ...
    test("target_fields_retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/knowledgebase/v1/target-fields")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.knowledgebase.fieldMapping.targetFieldsRetrieve();
        expect(response).toEqual({
            container: [
                {
                    name: "example_target_field_name",

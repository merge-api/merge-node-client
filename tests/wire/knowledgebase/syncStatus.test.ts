    ...
    test("list", async () => {
        ...
        const rawResponseBody = {
            ...
            results: [
                {
                    model_name: "Article",
                    model_id: "knowledgebase.KnowledgeBaseArticle",
        ...
        server
            .mockEndpoint()
            .get("/knowledgebase/v1/sync-status")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.knowledgebase.syncStatus.list({
        ...
        expect(response).toEqual({
            ...
            results: [
                {
                    modelName: "Article",
                    modelId: "knowledgebase.KnowledgeBaseArticle",

...
describe("ScopesClient", () => {
    test("default_scopes_retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/knowledgebase/v1/default-scopes")
            .respondWith()
            .statusCode(200)
    ...
    test("linked_account_scopes_retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/knowledgebase/v1/linked-account-scopes")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.knowledgebase.scopes.linkedAccountScopesRetrieve();
        expect(response).toEqual({
            commonModels: [
                {
                    modelName: "Employee",
    ...
    test("linked_account_scopes_create", async () => {
        ...
        server
            .mockEndpoint()
            .post("/knowledgebase/v1/linked-account-scopes")
        ...
        const response = await client.knowledgebase.scopes.linkedAccountScopesCreate({
            commonModels: [
                {
                    modelName: "Employee",
                    modelPermissions: {

...
describe("Folders", () => {
            ...
            results: [
                {
                    ...
                    remote_data: [{ path: "/folders", data: ["Varies by platform"] }],
                },
            ],
        };
        server
            ...
            results: [
                {
                    ...
                    size: 2738000,
                    description: "All things R&D related at Merge!",
                    parentFolder: "47ce474c-asdf-34a2-754r-629f799f7d31",
                    drive: "31ce474c-asdf-34a2-754r-629f799f7d12",
                    permissions: [
                        {
                            id: "105b9265-0d52-4e5c-bb88-0cb681ec77f6",
                    ...
                    remoteCreatedAt: new Date("2024-02-02T00:00:00.000Z"),
                    remoteUpdatedAt: new Date("2024-06-10T00:00:00.000Z"),
    ...
    test("create", async () => {
        ...
        const response = await client.filestorage.folders.create({
            model: {},
        });
        expect(response).toEqual({
            model: {
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/filestorage/v1/folders/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.filestorage.folders.metaPostRetrieve();
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {

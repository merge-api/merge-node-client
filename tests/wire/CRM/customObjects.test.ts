...
describe("CustomObjectsClient", () => {
    test("custom_object_classes_custom_objects_list", async () => {
            ...
            results: [
                {
                    ...
                    fields: { order_id: "4183634295", order_quantity: 50, customer_type: "Returning" },
        ...
        server
            ...
            .get("/crm/v1/custom-object-classes/custom_object_class_id/custom-objects")
            .respondWith()
            .statusCode(200)
        ...
        const page = await client.crm.customObjects.customObjectClassesCustomObjectsList("custom_object_class_id", {
    ...
    test("custom_object_classes_custom_objects_create", async () => {
        const server = mockServerPool.createServer();
        const client = new MergeClient({
            maxRetries: 0,
            apiKey: "test",
        ...
        const rawRequestBody = { model: { fields: { test_field: "hello" } } };
        const rawResponseBody = {
            model: {
                id: "da0b1963-be70-469c-9f8c-06a81d0fe759",
                remote_id: "4183634295",
        ...
        server
            .mockEndpoint()
            .post("/crm/v1/custom-object-classes/custom_object_class_id/custom-objects")
        ...
        const response = await client.crm.customObjects.customObjectClassesCustomObjectsCreate(
    ...
    test("custom_object_classes_custom_objects_retrieve", async () => {
        const server = mockServerPool.createServer();
        const client = new MergeClient({
            maxRetries: 0,
            apiKey: "test",
        ...
        server
            .mockEndpoint()
            .get("/crm/v1/custom-object-classes/custom_object_class_id/custom-objects/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.crm.customObjects.customObjectClassesCustomObjectsRetrieve(
            "custom_object_class_id",
            "id",
            {
                includeRemoteData: true,
    ...
    test("custom_object_classes_custom_objects_meta_post_retrieve", async () => {
        const server = mockServerPool.createServer();
        const client = new MergeClient({
            maxRetries: 0,
            apiKey: "test",
        ...
        server
            .mockEndpoint()
            .get("/crm/v1/custom-object-classes/custom_object_class_id/custom-objects/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("custom_object_classes_custom_objects_remote_field_classes_list", async () => {
        const server = mockServerPool.createServer();
        const client = new MergeClient({
            maxRetries: 0,
            apiKey: "test",
        ...
        server
            .mockEndpoint({ once: false })
            .get("/crm/v1/custom-object-classes/custom-objects/remote-field-classes")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
        ...
        const page = await client.crm.customObjects.customObjectClassesCustomObjectsRemoteFieldClassesList({
            cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
            includeDeletedData: true,
            includeRemoteData: true,
            includeRemoteFields: true,

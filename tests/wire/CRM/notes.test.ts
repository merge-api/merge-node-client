...
describe("NotesClient", () => {
    ...
    test("create", async () => {
        ...
        const response = await client.crm.notes.create({
            isDebugMode: true,
            runAsync: true,
            model: {},
        });
    ...
    test("retrieve", async () => {
        ...
        server.mockEndpoint().get("/crm/v1/notes/id").respondWith().statusCode(200).jsonBody(rawResponseBody).build();

        const response = await client.crm.notes.retrieve("id", {
            includeRemoteData: true,
            includeRemoteFields: true,
            includeShellData: true,
        });
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/crm/v1/notes/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.crm.notes.metaPostRetrieve();
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {
    ...
    test("remoteFieldClassesList", async () => {
        ...
        server
            .mockEndpoint({ once: false })
            .get("/crm/v1/notes/remote-field-classes")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
        ...
        const page = await client.crm.notes.remoteFieldClassesList({
            cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
            includeDeletedData: true,
            includeRemoteData: true,
            includeRemoteFields: true,

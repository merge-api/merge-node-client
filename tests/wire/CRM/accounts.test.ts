...
describe("AccountsClient", () => {
                    ...
                    phoneNumbers: [
                        {
                            createdAt: new Date("2021-09-15T00:00:00.000Z"),
                            modifiedAt: new Date("2021-10-16T00:00:00.000Z"),
                            phoneNumber: "+16788879833",
                            phoneNumberType: "Mobile",
                        },
                    ],
                    lastActivityAt: new Date("2022-02-10T00:00:00.000Z"),
                    remoteUpdatedAt: new Date("2022-01-09T00:00:00.000Z"),
    ...
    test("create", async () => {
        ...
        const response = await client.crm.accounts.create({
            isDebugMode: true,
            runAsync: true,
            model: {},
        });
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/crm/v1/accounts/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.crm.accounts.retrieve("id", {
            includeRemoteData: true,
            includeRemoteFields: true,
            includeShellData: true,
        });
    ...
    test("partialUpdate", async () => {
        ...
        const response = await client.crm.accounts.partialUpdate("id", {
            isDebugMode: true,
            runAsync: true,
            model: {},
        });
    ...
    test("metaPatchRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/crm/v1/accounts/meta/patch/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.crm.accounts.metaPatchRetrieve("id");
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/crm/v1/accounts/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.crm.accounts.metaPostRetrieve();
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {
    ...
    test("remoteFieldClassesList", async () => {
        ...
        server
            .mockEndpoint({ once: false })
            .get("/crm/v1/accounts/remote-field-classes")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
        ...
        const page = await client.crm.accounts.remoteFieldClassesList({
            cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
            includeDeletedData: true,
            includeRemoteData: true,
            includeRemoteFields: true,

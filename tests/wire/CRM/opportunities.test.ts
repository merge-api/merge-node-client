...
describe("OpportunitiesClient", () => {
    ...
    test("create", async () => {
        ...
        const response = await client.crm.opportunities.create({
            isDebugMode: true,
            runAsync: true,
            model: {},
        });
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/crm/v1/opportunities/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.crm.opportunities.retrieve("id", {
            includeRemoteData: true,
            includeRemoteFields: true,
            includeShellData: true,
            remoteFields: "status",
    ...
    test("partialUpdate", async () => {
        ...
        const response = await client.crm.opportunities.partialUpdate("id", {
            isDebugMode: true,
            runAsync: true,
            model: {},
        });
    ...
    test("metaPatchRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/crm/v1/opportunities/meta/patch/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.crm.opportunities.metaPatchRetrieve("id");
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/crm/v1/opportunities/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.crm.opportunities.metaPostRetrieve();
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {
    ...
    test("remoteFieldClassesList", async () => {
        ...
        server
            .mockEndpoint({ once: false })
            .get("/crm/v1/opportunities/remote-field-classes")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
        ...
        const page = await client.crm.opportunities.remoteFieldClassesList({
            cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
            includeDeletedData: true,
            includeRemoteData: true,
            includeRemoteFields: true,

...
describe("ScopesClient", () => {
    test("default_scopes_retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/chat/v1/default-scopes")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.chat.scopes.defaultScopesRetrieve();
    ...
    test("linked_account_scopes_retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/chat/v1/linked-account-scopes")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.chat.scopes.linkedAccountScopesRetrieve();
        expect(response).toEqual({
            commonModels: [
                {
                    modelName: "Employee",
    ...
    test("linked_account_scopes_create", async () => {
        ...
        server
            .mockEndpoint()
            .post("/chat/v1/linked-account-scopes")
        ...
        const response = await client.chat.scopes.linkedAccountScopesCreate({
            commonModels: [
                {
                    modelName: "Employee",
                    modelPermissions: {

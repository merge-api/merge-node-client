...
describe("Interviews", () => {
    test("list", async () => {
        ...
        server.mockEndpoint().get("/ats/v1/interviews").respondWith().statusCode(200).jsonBody(rawResponseBody).build();

        const response = await client.ats.interviews.list();
            ...
            results: [
                {
                    ...
                    remoteUpdatedAt: new Date("2021-10-15T00:00:00.000Z"),
                    status: "SCHEDULED",
    ...
    test("create", async () => {
        ...
        const response = await client.ats.interviews.create({
            model: {},
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ats/v1/interviews/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ats.interviews.retrieve("id");
        expect(response).toEqual({
            id: "b8faf072-98b9-4445-8a9a-6b4950efca19",
            remoteId: "3",
            createdAt: new Date("2021-09-15T00:00:00.000Z"),
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ats/v1/interviews/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ats.interviews.metaPostRetrieve();
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {

...
describe("Applications", () => {
    test("list", async () => {
            ...
            results: [
                {
                    ...
                    offers: ["e9b5c11d-c588-468e-8567-cd6992e42b62"],
                    source: "Campus recruiting event",
                    credited_to: "credited_to",
                    screening_question_answers: ["screening_question_answers", "screening_question_answers"],
        ...
        server
            .mockEndpoint()
            .get("/ats/v1/applications")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ats.applications.list();
            ...
            results: [
                {
                    ...
                    screeningQuestionAnswers: ["screening_question_answers", "screening_question_answers"],
    ...
    test("create", async () => {
        ...
        const response = await client.ats.applications.create({
            model: {},
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ats/v1/applications/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ats.applications.retrieve("id");
        expect(response).toEqual({
            id: "92e8a369-fffe-430d-b93a-f7e8a16563f1",
            remoteId: "98796",
            createdAt: new Date("2021-09-15T00:00:00.000Z"),
    ...
    test("changeStageCreate", async () => {
        ...
        server
            .mockEndpoint()
            .post("/ats/v1/applications/id/change-stage")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
        ...
        const response = await client.ats.applications.changeStageCreate("id");
        expect(response).toEqual({
            model: {
                id: "92e8a369-fffe-430d-b93a-f7e8a16563f1",
                remoteId: "98796",
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ats/v1/applications/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ats.applications.metaPostRetrieve();
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {

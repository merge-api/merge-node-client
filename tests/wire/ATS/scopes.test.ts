...
describe("ScopesClient", () => {
    ...
    test("linked_account_scopes_retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ats/v1/linked-account-scopes")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ats.scopes.linkedAccountScopesRetrieve();
        expect(response).toEqual({
            commonModels: [
                {
                    modelName: "Employee",
    ...
    test("linked_account_scopes_create", async () => {
        ...
        server
            .mockEndpoint()
            .post("/ats/v1/linked-account-scopes")
        ...
        const response = await client.ats.scopes.linkedAccountScopesCreate({
            commonModels: [
                {
                    modelName: "Employee",
                    modelPermissions: {

...
describe("CandidatesClient", () => {
    test("list", async () => {
        ...
        const page = await client.ats.candidates.list({
    ...
    test("create", async () => {
        ...
        const response = await client.ats.candidates.create({
            isDebugMode: true,
            runAsync: true,
            model: {},
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ats/v1/candidates/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ats.candidates.retrieve("id", {
            includeRemoteData: true,
            includeShellData: true,
        });
        expect(response).toEqual({
    ...
    test("partialUpdate", async () => {
        ...
        const response = await client.ats.candidates.partialUpdate("id", {
            isDebugMode: true,
            runAsync: true,
            model: {},
            remoteUserId: "remote_user_id",
    ...
    test("ignoreCreate", async () => {
        ...
        server
            .mockEndpoint()
            .post("/ats/v1/candidates/ignore/model_id")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .build();

        const response = await client.ats.candidates.ignoreCreate("model_id", {
    ...
    test("metaPatchRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ats/v1/candidates/meta/patch/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ats.candidates.metaPatchRetrieve("id");
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ats/v1/candidates/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ats.candidates.metaPostRetrieve();
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {

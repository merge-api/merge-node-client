...
describe("ActivitiesClient", () => {
    test("list", async () => {
        ...
        const page = await client.ats.activities.list({
    ...
    test("create", async () => {
        ...
        const response = await client.ats.activities.create({
            isDebugMode: true,
            runAsync: true,
            model: {},
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ats/v1/activities/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ats.activities.retrieve("id", {
            includeRemoteData: true,
            includeShellData: true,
            remoteFields: "activity_type",
            showEnumOrigins: "activity_type",
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ats/v1/activities/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ats.activities.metaPostRetrieve();
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {

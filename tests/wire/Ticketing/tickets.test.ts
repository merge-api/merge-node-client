...
describe("TicketsClient", () => {
            ...
            results: [
                {
                    ...
                    assigned_teams: ["4857c306-c1f9-489e-a6b6-90902f736dfe"],
                    creator: "creator",
                    ...
                    permissions: [
                        {
                            ...
                            applied_to_users: ["28b54125-287f-494d-965e-3c5b330c9a68"],
                            applied_to_roles: ["23454124-387f-494d-265e-345b330c9123"],
                            applied_to_teams: ["17a54124-287f-494d-965e-3c5b330c9a68"],
                            applied_to_collections: ["fb8c55b6-1cb8-4b4c-9fb6-17924231619d"],
                            field_mappings: {
                    ...
                    roles: ["21a54124-397f-494d-985e-3c5b330b8a68", "17a54124-287f-494d-965e-3c5b330c9a68"],
            ...
            results: [
                {
                    ...
                    name: "Please add more integrations",
                    assignees: ["17a54124-287f-494d-965e-3c5b330c9a68"],
                    assignedTeams: ["4857c306-c1f9-489e-a6b6-90902f736dfe"],
                    creator: "creator",
                    ...
                    permissions: [
                        {
                            ...
                            modifiedAt: new Date("2021-10-16T00:00:00.000Z"),
                            actions: ["VIEW", "EDIT", "CREATE"],
                            appliedToUsers: ["28b54125-287f-494d-965e-3c5b330c9a68"],
                            appliedToRoles: ["23454124-387f-494d-265e-345b330c9123"],
                            appliedToTeams: ["17a54124-287f-494d-965e-3c5b330c9a68"],
                            appliedToCollections: ["fb8c55b6-1cb8-4b4c-9fb6-17924231619d"],
                            fieldMappings: {
                    ...
                    remoteUpdatedAt: new Date("2021-12-09T00:00:00.000Z"),
    ...
    test("create", async () => {
        ...
        const response = await client.ticketing.tickets.create({
            isDebugMode: true,
            runAsync: true,
            model: {},
        });
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ticketing/v1/tickets/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ticketing.tickets.retrieve("id", {
            includeRemoteData: true,
            includeRemoteFields: true,
            includeShellData: true,
            remoteFields: "priority",
    ...
    test("partialUpdate", async () => {
        ...
        const response = await client.ticketing.tickets.partialUpdate("id", {
            isDebugMode: true,
            runAsync: true,
            model: {},
        });
    ...
    test("viewersList", async () => {
        ...
        server
            .mockEndpoint({ once: false })
            .get("/ticketing/v1/tickets/ticket_id/viewers")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
        ...
        const page = await client.ticketing.tickets.viewersList("ticket_id", {
            cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
            includeDeletedData: true,
            includeRemoteData: true,
            includeShellData: true,
    ...
    test("metaPatchRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ticketing/v1/tickets/meta/patch/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ticketing.tickets.metaPatchRetrieve("id");
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ticketing/v1/tickets/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ticketing.tickets.metaPostRetrieve({
    ...
    test("remoteFieldClassesList", async () => {
        ...
        server
            .mockEndpoint({ once: false })
            .get("/ticketing/v1/tickets/remote-field-classes")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
        ...
        const page = await client.ticketing.tickets.remoteFieldClassesList({
            cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
            ids: "ids",
            includeDeletedData: true,
            includeRemoteData: true,

...
describe("AsyncPassthroughClient", () => {
    test("create", async () => {
        ...
        server
            .mockEndpoint()
            .post("/accounting/v1/async-passthrough")
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/accounting/v1/async-passthrough/async_passthrough_receipt_id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.accounting.asyncPassthrough.retrieve("async_passthrough_receipt_id");
        expect(response).toEqual({
            method: "GET",
            path: "/scooters",
            status: 200,

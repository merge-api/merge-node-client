...
describe("Items", () => {
    test("list", async () => {
            ...
            results: [
                {
                    ...
                    purchase_tax_rate: "983e8f97-9qw2-34v9-p123-67bdf98740v5",
                    sales_tax_rate: "232c8f56-7se4-98f2-y334-12bdf89249f5",
        ...
        server
            .mockEndpoint()
            .get("/accounting/v1/items")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.accounting.items.list({
            ...
            results: [
                {
                    ...
                    company: "595c8f97-2ac4-45b7-b000-41bdf43240b5",
                    purchaseTaxRate: "983e8f97-9qw2-34v9-p123-67bdf98740v5",
                    salesTaxRate: "232c8f56-7se4-98f2-y334-12bdf89249f5",
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/accounting/v1/items/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.accounting.items.retrieve("id");
        expect(response).toEqual({
            id: "d2f972d0-2526-434b-9409-4c3b468e08f0",
            remoteId: "12374",
            createdAt: new Date("2021-09-15T00:00:00.000Z"),
    ...
    test("partialUpdate", async () => {
        ...
        const response = await client.accounting.items.partialUpdate("id", {
            model: {},
        });
        expect(response).toEqual({
            model: {
    ...
    test("metaPatchRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/accounting/v1/items/meta/patch/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.accounting.items.metaPatchRetrieve("id");
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/accounting/v1/items/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.accounting.items.metaPostRetrieve();
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {

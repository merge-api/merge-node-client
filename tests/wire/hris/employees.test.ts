...
describe("Employees", () => {
    test("list", async () => {
        ...
        server.mockEndpoint().get("/hris/v1/employees").respondWith().statusCode(200).jsonBody(rawResponseBody).build();

        const response = await client.hris.employees.list();
            ...
            results: [
                {
                    ...
                    remoteCreatedAt: new Date("2020-10-11T00:00:00.000Z"),
    ...
    test("create", async () => {
        ...
        const response = await client.hris.employees.create({
            model: {},
        });
        expect(response).toEqual({
            model: {
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/hris/v1/employees/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.hris.employees.retrieve("id");
        expect(response).toEqual({
            id: "0958cbc6-6040-430a-848e-aafacbadf4ae",
            remoteId: "19202938",
            createdAt: new Date("2021-09-15T00:00:00.000Z"),
    ...
    test("ignoreCreate", async () => {
        ...
        server
            .mockEndpoint()
            .post("/hris/v1/employees/ignore/model_id")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .build();

        const response = await client.hris.employees.ignoreCreate("model_id", {
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/hris/v1/employees/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

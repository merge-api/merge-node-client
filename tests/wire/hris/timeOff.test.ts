...
describe("TimeOffClient", () => {
    test("list", async () => {
        ...
        server.mockEndpoint().get("/hris/v1/time-off").respondWith().statusCode(200).jsonBody(rawResponseBody).build();

        const response = await client.hris.timeOff.list({
    ...
    test("create", async () => {
        ...
        const response = await client.hris.timeOff.create({
            isDebugMode: true,
            runAsync: true,
            model: {},
        });
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/hris/v1/time-off/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.hris.timeOff.retrieve("id", {
            expand: "approver",
            includeRemoteData: true,
            includeShellData: true,
            remoteFields: "request_type",
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/hris/v1/time-off/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.hris.timeOff.metaPostRetrieve();
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {

...
describe("ScopesClient", () => {
    ...
    test("linked_account_scopes_retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/hris/v1/linked-account-scopes")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.hris.scopes.linkedAccountScopesRetrieve();
        expect(response).toEqual({
            commonModels: [
                {
                    modelName: "Employee",
    ...
    test("linked_account_scopes_create", async () => {
        ...
        server
            .mockEndpoint()
            .post("/hris/v1/linked-account-scopes")
        ...
        const response = await client.hris.scopes.linkedAccountScopesCreate({
            commonModels: [
                {
                    modelName: "Employee",
                    modelPermissions: {

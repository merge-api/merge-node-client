...
describe("AttachmentsClient", () => {
    ...
    test("create", async () => {
        ...
        server
            .mockEndpoint()
            .post("/accounting/v1/attachments")
        ...
        const response = await client.accounting.attachments.create({
            isDebugMode: true,
            runAsync: true,
            body: {
                model: {},
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/accounting/v1/attachments/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.accounting.attachments.retrieve("id", {
            includeRemoteData: true,
            includeShellData: true,
        });
        expect(response).toEqual({
    ...
    test("batchObjectsList", async () => {
        ...
        const page = await client.accounting.attachments.batchObjectsList("batch_id", {
            companyId: "company_id",
            createdAfter: new Date("2024-01-15T09:30:00.000Z"),
            createdBefore: new Date("2024-01-15T09:30:00.000Z"),
            cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/accounting/v1/attachments/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

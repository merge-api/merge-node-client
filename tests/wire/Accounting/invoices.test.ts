...
describe("InvoicesClient", () => {
    ...
    test("batchObjectsList", async () => {
        ...
        const page = await client.accounting.invoices.batchObjectsList("batch_id", {
            companyId: "company_id",
            contactId: "contact_id",
            createdAfter: new Date("2024-01-15T09:30:00.000Z"),
            createdBefore: new Date("2024-01-15T09:30:00.000Z"),
    ...
    test("lineItemsRemoteFieldClassesList", async () => {
        ...
        const page = await client.accounting.invoices.lineItemsRemoteFieldClassesList({
            cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
            includeDeletedData: true,
            includeRemoteData: true,
            includeShellData: true,
    ...
    test("remoteFieldClassesList", async () => {
        ...
        const page = await client.accounting.invoices.remoteFieldClassesList({
            cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
            includeDeletedData: true,
            includeRemoteData: true,
            includeShellData: true,

...
describe("AccountsClient", () => {
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/accounting/v1/accounts/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.accounting.accounts.retrieve("id", {
            includeRemoteData: true,
            includeShellData: true,
            remoteFields: "classification",
            showEnumOrigins: "classification",
    ...
    test("batchObjectsList", async () => {
        ...
        const page = await client.accounting.accounts.batchObjectsList("batch_id", {
            accountType: "account_type",
            classification: "",
            companyId: "company_id",
            createdAfter: new Date("2024-01-15T09:30:00.000Z"),
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/accounting/v1/accounts/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.accounting.accounts.metaPostRetrieve();
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {

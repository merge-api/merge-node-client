...
describe("ItemFulfillmentsClient", () => {
            ...
            results: [
                {
                    ...
                    fulfillment_date: "2022-04-10T00:00:00Z",
                    customer: "customer",
                    company: "company",
                    status: "DRAFT",
                    ...
                    remote_data: [{ path: "/actions", data: { field: "Varies by platform" } }],
            ...
            results: [
                {
                    ...
                    fulfillmentDate: new Date("2022-04-10T00:00:00.000Z"),
                    customer: "customer",
                    company: "company",
                    status: "DRAFT",
                    memo: "Shipped via FedEx",
    ...
    test("batchObjectsList", async () => {
        ...
        const page = await client.accounting.itemFulfillments.batchObjectsList("batch_id", {
            cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
            includeDeletedData: true,
            includeRemoteData: true,
            includeRemoteFields: true,
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/accounting/v1/item-fulfillments/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.accounting.itemFulfillments.metaPostRetrieve();
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {

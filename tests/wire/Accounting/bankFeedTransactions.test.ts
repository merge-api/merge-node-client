...
describe("BankFeedTransactionsClient", () => {
    test("list", async () => {
        ...
        server
            ...
            .get("/accounting/v1/bank-feed-transactions")
            .respondWith()
            .statusCode(200)
        ...
        const page = await client.accounting.bankFeedTransactions.list({
    ...
    test("create", async () => {
        ...
        server
            .mockEndpoint()
            .post("/accounting/v1/bank-feed-transactions")
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/accounting/v1/bank-feed-transactions/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.accounting.bankFeedTransactions.retrieve("id", {
            includeRemoteData: true,
            includeShellData: true,
        });
        expect(response).toEqual({
    ...
    test("batchObjectsList", async () => {
        ...
        const page = await client.accounting.bankFeedTransactions.batchObjectsList("batch_id", {
            createdAfter: new Date("2024-01-15T09:30:00.000Z"),
            createdBefore: new Date("2024-01-15T09:30:00.000Z"),
            cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
            includeDeletedData: true,
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/accounting/v1/bank-feed-transactions/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.accounting.bankFeedTransactions.metaPostRetrieve();
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {

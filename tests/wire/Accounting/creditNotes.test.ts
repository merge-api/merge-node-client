...
describe("CreditNotesClient", () => {
    ...
    test("partialUpdate", async () => {
        ...
        server
            .mockEndpoint()
            .patch("/accounting/v1/credit-notes/id")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
        ...
        const response = await client.accounting.creditNotes.partialUpdate("id", {
            isDebugMode: true,
            runAsync: true,
            model: {},
        });
    ...
    test("applicationCreate", async () => {
        ...
        server
            .mockEndpoint()
            .post("/accounting/v1/credit-notes/id/application")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
        ...
        const response = await client.accounting.creditNotes.applicationCreate("id", {
            isDebugMode: true,
            runAsync: true,
    ...
    test("batchObjectsList", async () => {
        ...
        const page = await client.accounting.creditNotes.batchObjectsList("batch_id", {
            companyId: "company_id",
            createdAfter: new Date("2024-01-15T09:30:00.000Z"),
            createdBefore: new Date("2024-01-15T09:30:00.000Z"),
            cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
    ...
    test("metaPatchRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/accounting/v1/credit-notes/meta/patch/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.accounting.creditNotes.metaPatchRetrieve("id");
        expect(response).toEqual({
            requestSchema: {
                type: "object",
                properties: {

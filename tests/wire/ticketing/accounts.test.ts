...
describe("Accounts", () => {
    test("list", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ticketing/v1/accounts")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ticketing.accounts.list();
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ticketing/v1/accounts/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ticketing.accounts.retrieve("id");
        expect(response).toEqual({
            id: "17a54124-287f-494d-965e-3c5b330c9a68",
            remoteId: "19202938",
            createdAt: new Date("2021-09-15T00:00:00.000Z"),

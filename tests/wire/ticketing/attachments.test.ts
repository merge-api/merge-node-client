...
describe("Attachments", () => {
    test("list", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ticketing/v1/attachments")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ticketing.attachments.list({
            ...
            results: [
                {
                    ...
                    remoteCreatedAt: new Date("2022-11-10T00:00:00.000Z"),
    ...
    test("create", async () => {
        ...
        const response = await client.ticketing.attachments.create({
            model: {},
        });
        expect(response).toEqual({
            model: {
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ticketing/v1/attachments/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ticketing.attachments.retrieve("id");
        expect(response).toEqual({
            id: "17a54124-287f-494d-965e-3c5b330c9a68",
            remoteId: "19202938",
            createdAt: new Date("2021-09-15T00:00:00.000Z"),
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ticketing/v1/attachments/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

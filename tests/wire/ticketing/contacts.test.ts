...
describe("Contacts", () => {
    test("list", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ticketing/v1/contacts")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ticketing.contacts.list({
    ...
    test("create", async () => {
        ...
        const response = await client.ticketing.contacts.create({
            model: {},
        });
        expect(response).toEqual({
            model: {
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ticketing/v1/contacts/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ticketing.contacts.retrieve("id");
        expect(response).toEqual({
            id: "17a54124-287f-494d-965e-3c5b330c9a68",
            remoteId: "19202938",
            createdAt: new Date("2021-09-15T00:00:00.000Z"),
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ticketing/v1/contacts/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

...
describe("CommentsClient", () => {
            ...
            results: [
                {
                    ...
                    ticket: "ticket",
                    isPrivate: true,
                    remoteCreatedAt: new Date("1990-11-10T00:00:00.000Z"),
    ...
    test("create", async () => {
        ...
        const response = await client.ticketing.comments.create({
            isDebugMode: true,
            runAsync: true,
            model: {},
        });
    ...
    test("retrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ticketing/v1/comments/id")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.ticketing.comments.retrieve("id", {
            expand: "contact",
            includeRemoteData: true,
            includeShellData: true,
        });
    ...
    test("metaPostRetrieve", async () => {
        ...
        server
            .mockEndpoint()
            .get("/ticketing/v1/comments/meta/post")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
